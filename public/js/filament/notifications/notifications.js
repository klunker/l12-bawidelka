(() => {
    function c(s, t = () => {}) {
        let i = !1;
        return function () {
            i ? t.apply(this, arguments) : ((i = !0), s.apply(this, arguments));
        };
    }
    var d = (s) => {
        s.data('notificationComponent', ({ notification: t }) => ({
            isShown: !1,
            computedStyle: null,
    ...
    var h = class {
            constructor() {
                return (this.id(crypto.randomUUID()), this);
            }
            id(t) {
        ...
        a = class {
            ...
            emitTo(t, i, e) {
                return (this.dispatchTo(t, i, e), this);
            }
            dispatchDirection(t) {
