...
function _a(i, t, e) {
    let s = Gt(mt(i.r)),
        ...
        o = Gt(mt(i.b));
    return {
        r: St(Ci(s + e * (Gt(mt(t.r)) - s))),
        g: St(Ci(n + e * (Gt(mt(t.g)) - n))),
        b: St(Ci(o + e * (Gt(mt(t.b)) - o))),
        a: i.a + e * (t.a - i.a),
    };
}
function Ke(i, t, e) {
...
var Ca = ['x', 'y', 'borderWidth', 'radius', 'tension'],
...
function On(i) {
    return i === 'angle'
        ? { between: se, compare: Oa, normalize: X }
...
function ls(i, t, e) {
    ...
    let { property: s, start: n, end: o } = e,
        a = t.length,
        { compare: r, between: l, normalize: c } = On(s),
...
var fs = (i) => i === 'reset' || i === 'none',
    ...
    it = class {
        ...
        _destroy() {
            let t = this._cachedMeta;
            (this._data && ji(this._data, this), t._stacked && Oe(t));
        }
        _dataCheck() {
    ...
    updateElements(t, e, s, n) {
        ...
        for (let _ = 0; _ < v; ++_) {
            ...
            let S = this.getParsed(_),
                P = A(S[f]),
                O = (w[u] = a.getPixelForValue(S[u], _)),
                C = (w[f] =
                    o || P
                        ? r.getBasePixel()
                        : r.getPixelForValue(
...
var Xt = class i extends st {
        ...
        getPixelForDecimal(t) {
            ...
            return rn(this._alignToPixels ? Ct(this.chart, e, 0) : e);
        }
        ...
        drawBorder() {
            ...
            let r = n.setContext(this.getContext(0)).lineWidth,
                ...
                u;
            (this.isHorizontal()
                ? ((c = Ct(t, this.left, a) - a / 2),
                  (h = Ct(t, this.right, r) + r / 2),
                  (d = u = l))
                : ((d = Ct(t, this.top, a) - a / 2),
                  (u = Ct(t, this.bottom, r) + r / 2),
                  (c = h = l)),
                e.save(),
                (e.lineWidth = o.width),
    ...
    pe = class {
        ...
        unregister(t) {
            ...
            (s in e && delete e[s],
                n &&
                    s in V[n] &&
                    (delete V[n][s], this.override && delete Ot[s]));
        }
    };
function Pl(i, t, e) {
...
var Le = (i, t, e) => {
    ...
    Ts = class {
        ...
        chartOptionScopes() {
            ...
            return [t, Ot[e] || {}, V.datasets[e] || {}, { type: e }, V, ai];
        }
                ...
                b = function (k, w, S) {
                    ...
                    if (
                        ...
                        let O = {
                            ...
                            C = l.xPlus(k, g / 2),
                            L = w + u;
                        Zi(n, O, C, L, a.pointStyleWidth && g);
                    } else {
                        let O = w + Math.max((d - p) / 2, 0),
                            C = l.leftForLtr(k, g),
                            L = Tt(S.borderRadius);
                        (n.beginPath(),
                            Object.values(L).some((U) => U !== 0)
                                ? oe(n, { x: C, y: O, w: g, h: p, radius: L })
                                : n.rect(C, O, g, p),
                            n.fill(),
                            P !== 0 && n.stroke());
                    }
...
function dh(i, t) {
    ...
    for (
        ...
        (u && w !== a
            ? (e.push({ value: a }),
              w < a && C++,
              ie(Math.round((w + C * _) * k) / k, a, vo(a, y, i)) && C++)
            : w < a && C++);
        C < P;
        ++C
    ) {
        let L = Math.round((w + C * _) * k) / k;
        if (x && L > r) break;
        e.push({ value: L });
    }
    return (
