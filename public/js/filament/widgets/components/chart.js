...
var Mc = (s, t, e) =>
    t in s
        ...
        : (s[t] = e);
var v = (s, t, e) => Mc(s, typeof t != 'symbol' ? t + '' : t, e);
function us(s) {
    return (s + 0.5) | 0;
}
var Zt = (s, t, e) => Math.max(Math.min(s, e), t);
function cs(s) {
    return Zt(us(s * 2.55), 0, 255);
}
function qt(s) {
    return Zt(us(s * 255), 0, 255);
}
function Nt(s) {
    return Zt(us(s / 2.55) / 100, 0, 1);
}
function No(s) {
    return Zt(us(s * 100), 0, 100);
}
var pt = {
        0: 0,
        1: 1,
    ...
    Zi = [...'0123456789ABCDEF'],
    Oc = (s) => Zi[s & 15],
    Tc = (s) => Zi[(s & 240) >> 4] + Zi[s & 15],
    Us = (s) => (s & 240) >> 4 === (s & 15),
    Dc = (s) => Us(s.r) && Us(s.g) && Us(s.b) && Us(s.a);
function Cc(s) {
    var t = s.length,
        e;
    return (
...
var Pc = (s, t) => (s < 255 ? t(s) : '');
function Ac(s) {
    var t = Dc(s) ? Oc : Tc;
    return s ? '#' + t(s.r) + t(s.g) + t(s.b) + Pc(s.a, t) : void 0;
}
var Ic =
...
var Ys;
function Hc(s) {
    Ys || ((Ys = Bc()), (Ys.transparent = [0, 0, 0, 0]));
    let t = Ys[s.toLowerCase()];
...
function jc(s) {
    ...
    if (t) {
        if (t[7] !== i) {
            let r = +t[7];
            e = t[8] ? cs(r) : Zt(r * 255, 0, 255);
        }
        return (
            (i = +t[1]),
            (n = +t[3]),
            (o = +t[5]),
            (i = 255 & (t[2] ? cs(i) : Zt(i, 0, 255))),
            (n = 255 & (t[4] ? cs(n) : Zt(n, 0, 255))),
            (o = 255 & (t[6] ? cs(o) : Zt(o, 0, 255))),
            { r: i, g: n, b: o, a: e }
        );
    }
}
...
var Yi = (s) =>
    ...
    De = (s) => (s <= 0.04045 ? s / 12.92 : Math.pow((s + 0.055) / 1.055, 2.4));
function Yc(s, t, e) {
    let i = De(Nt(s.r)),
        n = De(Nt(s.g)),
        o = De(Nt(s.b));
    return {
        r: qt(Yi(i + e * (De(Nt(t.r)) - i))),
        g: qt(Yi(n + e * (De(Nt(t.g)) - n))),
        b: qt(Yi(o + e * (De(Nt(t.b)) - o))),
        a: s.a + e * (t.a - s.a),
    };
}
function Zs(s, t, e) {
...
function Wo(s) {
    ...
    return (
        Array.isArray(s)
            ...
            : ((t = $o(s, { r: 0, g: 0, b: 0, a: 1 })), (t.a = qt(t.a))),
        t
    );
}
function Zc(s) {
    return s.charAt(0) === 'r' ? jc(s) : zc(s);
}
var hs = class s {
    constructor(t) {
    ...
    interpolate(t, e) {
        return (t && (this._rgb = Yc(this._rgb, t._rgb, e)), this);
    }
    clone() {
    ...
    greyscale() {
        let t = this._rgb,
            e = us(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
    ...
    lighten(t) {
        return (Zs(this._rgb, 2, t), this);
    }
    darken(t) {
        return (Zs(this._rgb, 2, -t), this);
    }
    saturate(t) {
        return (Zs(this._rgb, 1, t), this);
    }
    desaturate(t) {
        return (Zs(this._rgb, 1, -t), this);
    }
    rotate(t) {
        return (Vc(this._rgb, t), this);
    }
};
function At() {}
var tr = (() => {
...
function Js(s) {
    if (H(s)) return s.map(Js);
    if (E(s)) {
        let t = Object.create(null),
            e = Object.keys(s),
            i = e.length,
            n = 0;
        for (; n < i; ++n) t[e[n]] = Js(s[e[n]]);
        return t;
    }
    return s;
}
...
function Gc(s, t, e) {
    ...
    E(i) && E(n)
        ? Ie(i, n)
        : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = Js(n));
}
var jo = { '': (s) => s, x: (s) => s.x, y: (s) => s.y };
function Xc(s) {
    let t = s.split('.'),
        e = [],
        i = '';
...
function Wt(s, t) {
    return (jo[t] || (jo[t] = Jc(t)))(s);
}
function ei(s) {
    return s.charAt(0).toUpperCase() + s.slice(1);
}
var Ee = (s) => typeof s < 'u',
    zt = (s) => typeof s == 'function',
    en = (s, t) => {
...
function sn(s) {
    let t = Math.round(s);
    s = Le(s, t, s / 1e3) ? t : s;
    let e = Math.pow(10, Math.floor(Vt(s))),
        i = s / e;
...
var cr = ['push', 'pop', 'shift', 'splice', 'unshift'];
function hr(s, t) {
    if (s._chartjs) {
...
var ni = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
    it = (s, t, e) => (s === 'start' ? t : s === 'end' ? e : (t + e) / 2),
    dr = (s, t, e, i) =>
...
function un(s, t, e) {
    let i = t.length,
        ...
        o = i;
    if (s._sorted) {
        let { iScale: r, vScale: a, _parsed: l } = s,
            c =
        ...
        if (f) {
            if (
                ((n = Math.min(
                    Ct(l, h, u).lo,
                    e ? i : Ct(t, h, r.getPixelForValue(u)).lo,
                )),
                c)
            ) {
                let m = l
        ...
        if (g) {
            let m = Math.max(
                Ct(l, r.axis, d, !0).hi + 1,
                e ? 0 : Ct(t, h, r.getPixelForValue(d), !0).hi + 1,
            );
            if (c) {
...
var qs = (s) => s === 0 || s === 1,
    ...
    Zo = (s, t, e) => Math.pow(2, -10 * s) * Math.sin(((s - t) * $) / e) + 1,
    Ce = {
        linear: (s) => s,
        easeInQuad: (s) => s * s,
        easeOutQuad: (s) => -s * (s - 2),
        ...
        easeInElastic: (s) => (qs(s) ? s : Yo(s, 0.075, 0.3)),
        easeOutElastic: (s) => (qs(s) ? s : Zo(s, 0.075, 0.3)),
        easeInOutElastic(s) {
            return qs(s)
                ? s
                : s < 0.5
                  ? 0.5 * Yo(s * 2, 0.1125, 0.45)
                  : 0.5 + 0.5 * Zo(s * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(s) {
...
function gn(s) {
    return fn(s) ? s : new hs(s);
}
function Ji(s) {
    return fn(s) ? s : new hs(s).saturate(0.5).darken(0.1).hexString();
}
var sh = ['x', 'y', 'borderWidth', 'radius', 'tension'],
    ih = ['color', 'borderColor', 'backgroundColor'];
function nh(s) {
    (s.set('animation', {
        delay: void 0,
        duration: 1e3,
        ...
        s.set('animations', {
            colors: { type: 'color', properties: ih },
...
function rh(s, t) {
    ...
    let e = s + JSON.stringify(t),
        i = qo.get(e);
    return (i || ((i = new Intl.NumberFormat(s, t)), qo.set(e, i)), i);
}
function Re(s, t, e) {
    return rh(t, e).format(s);
}
var fr = {
    values(s) {
        return H(s) ? s : '' + s;
    ...
    numeric(s, t, e) {
        ...
        return (Object.assign(l, this.options.ticks.format), Re(s, i, l));
    },
    logarithmic(s, t, e) {
        if (s === 0) return '0';
        let i = e[t].significand || s / Math.pow(10, Math.floor(Vt(s)));
        return [1, 2, 3, 5, 10, 15].includes(i) || t > 0.8 * e.length
            ? fr.numeric.call(this, s, t, e)
            : '';
    },
};
function ah(s, t) {
...
function Ki(s, t, e) {
    return typeof t == 'string' ? Pe(ds(s, t), e) : Pe(ds(s, ''), t);
}
var Qi = class {
        constructor(t, e) {
...
function gr(s, t, e, i) {
    ...
    let r = 0,
        ...
        d;
    for (l = 0; l < a; l++)
        if (((u = e[l]), u != null && !H(u))) r = fs(s, n, o, r, u);
        else if (H(u))
            for (c = 0, h = u.length; c < h; c++)
                ((d = u[c]), d != null && !H(d) && (r = fs(s, n, o, r, d)));
    s.restore();
    let f = o.length / 2;
    if (f > e.length) {
        ...
        switch ((s.beginPath(), f)) {
            ...
            case 'rectRounded':
                ((c = m * 0.516),
                    (l = m - c),
                    (r = Math.cos(p + he) * l),
                    (u = Math.cos(p + he) * (n ? n / 2 - c : l)),
                    (a = Math.sin(p + he) * l),
                    (d = Math.sin(p + he) * (n ? n / 2 - c : l)),
...
function Qt(s, t, e, i, n, o = {}) {
    let r = H(t) ? t : [t],
        a = o.strokeWidth > 0 && o.strokeColor !== '',
        l,
        c;
    for (s.save(), s.font = n.string, hh(s, o), l = 0; l < r.length; ++l)
        ((c = r[l]),
            o.backdrop && dh(s, o.backdrop),
            a &&
                (o.strokeColor && (s.strokeStyle = o.strokeColor),
                I(o.strokeWidth) || (s.lineWidth = o.strokeWidth),
...
function ai(s, t) {
    let e = {},
        i = E(t),
        n = i ? Object.keys(t) : t,
        o = E(s) ? (i ? (r) => P(s[r], s[t[r]]) : (r) => s[r]) : () => s;
    for (let r of n) e[r] = ph(o(r));
    return e;
}
function bn(s) {
...
function X(s, t) {
    ...
    let n = {
        ...
        lineHeight: mh(P(s.lineHeight, t.lineHeight), e),
        size: e,
        style: i,
        weight: P(s.weight, t.weight),
        string: '',
    };
    return ((n.string = ch(n)), n);
}
function ze(s, t, e, i) {
    let n = !0,
        o,
...
function de(s, t, e, i) {
    let n = {
        ...
        _stack: new Set(),
        _descriptors: yn(s, i),
        setContext: (o) => de(s, o, e, i),
        override: (o) => de(s.override(o), t, e, i),
    };
    return new Proxy(n, {
        deleteProperty(o, r) {
...
function yn(s, t = { scriptable: !0, indexable: !0 }) {
    let {
...
function yh(s, t, e) {
    let { _proxy: i, _context: n, _subProxy: o, _descriptors: r } = s,
        a = i[t];
    return (
        zt(a) && r.isScriptable(t) && (a = xh(t, a, s, e)),
        H(a) && a.length && (a = _h(t, a, s, r.isIndexable)),
        xn(t, a) && (a = de(a, n, o && o[t], r)),
        a
    );
}
function xh(s, t, e, i) {
    ...
    a.add(s);
    let l = t(o, r || i);
    return (a.delete(s), xn(s, l) && (l = _n(n._scopes, n, s, l)), l);
}
function _h(s, t, e, i) {
...
var wh = (s, t) => (s === !0 ? t : typeof s == 'string' ? Wt(t, s) : void 0);
function kh(s, t, e, i, n) {
    for (let o of t) {
        let r = wh(e, o);
        if (r) {
            s.add(r);
            let a = xr(r._fallback, e, n);
...
function _n(s, t, e, i) {
    let n = t._rootScopes,
        o = xr(t._fallback, e, i),
        r = [...s, ...n],
        a = new Set();
    a.add(i);
    let l = Go(a, r, e, o || e, i);
    return l === null ||
        (typeof o < 'u' && o !== e && ((l = Go(a, r, o, l, i)), l === null))
        ? !1
        : li(Array.from(a), [''], n, o, () => vh(t, e, i));
}
function Go(s, t, e, i, n) {
    for (; e; ) e = kh(s, t, e, i, n);
    return e;
}
function vh(s, t, e) {
    let i = s._getTarget();
...
function Sh(s, t, e, i) {
    let n;
    for (let o of t)
        if (((n = _r(bh(o, s), e)), typeof n < 'u'))
            return xn(s, n) ? _n(e, i, s, n) : n;
}
function _r(s, t) {
    for (let e of t) {
        if (!e) continue;
...
function Xo(s) {
    let t = s._keys;
    return (t || (t = s._keys = Mh(s._scopes)), t);
}
function Mh(s) {
    let t = new Set();
    for (let e of s)
...
var Oh = Number.EPSILON || 1e-14,
    Ae = (s, t) => t < s.length && !s[t].skip && s[t],
    wr = (s) => (s === 'x' ? 'y' : 'x');
function Th(s, t, e, i) {
    let n = s.skip ? t : s,
        o = t,
...
function Ch(s, t, e = 'x') {
    let i = wr(e),
        ...
        l = Ae(s, 0);
    for (let c = 0; c < n; ++c) {
        if (((r = a), (a = l), (l = Ae(s, c + 1)), !a)) continue;
        let h = a[e],
            u = a[i];
        (r &&
            ((o = (h - r[e]) / 3),
    ...
    for (e = 0, i = s.length; e < i; ++e)
        ((r = o),
            ...
            o &&
                ((n = s[e]),
                r &&
                    ((n.cp1x = Gs(n.cp1x, t.left, t.right)),
                    (n.cp1y = Gs(n.cp1y, t.top, t.bottom))),
                a &&
                    ((n.cp2x = Gs(n.cp2x, t.left, t.right)),
                    (n.cp2y = Gs(n.cp2y, t.top, t.bottom)))));
}
...
var ui = (s) => s.ownerDocument.defaultView.getComputedStyle(s, null);
function Ih(s, t) {
...
var Lh = (s, t, e) => (s > 0 || t > 0) && (!e || !e.shadowRoot);
function Fh(s, t) {
    let e = s.touches,
        i = e && e.length ? e[0] : s,
...
function Rh(s, t, e) {
    ...
    return { width: t, height: e, maxWidth: i || Ks, maxHeight: n || Ks };
}
var Xt = (s) => Math.round(s * 10) / 10;
function vr(s, t, e, i) {
    let n = ui(s),
        o = ue(n, 'margin'),
        r = ti(n.maxWidth, s, 'clientWidth') || Ks,
        a = ti(n.maxHeight, s, 'clientHeight') || Ks,
        l = Rh(s, t, e),
        { width: c, height: h } = l;
    if (n.boxSizing === 'content-box') {
        let d = ue(n, 'border', 'width'),
            f = ue(n, 'padding');
    ...
    return (
        ...
        (c = Xt(Math.min(c, r, l.maxWidth))),
        (h = Xt(Math.min(h, a, l.maxHeight))),
        c && !h && (h = Xt(c / 2)),
        (t !== void 0 || e !== void 0) &&
            i &&
            l.height &&
            h > l.height &&
            ((h = l.height), (c = Xt(Math.floor(h * i)))),
        { width: c, height: h }
    );
}
function kn(s, t, e) {
    let i = t || 1,
        n = Xt(s.height * i),
        o = Xt(s.width * i);
    ((s.height = Xt(s.height)), (s.width = Xt(s.width)));
    let r = s.canvas;
    return (
        r.style &&
...
function Tr(s) {
    return s === 'angle'
        ? { between: Fe, compare: eh, normalize: st }
...
function On(s, t, e) {
    ...
    let { property: i, start: n, end: o } = e,
        r = t.length,
        { compare: a, between: l, normalize: c } = Tr(i),
        { start: h, end: u, loop: d, style: f } = Vh(s, t, e),
        g = [],
        m = !1,
        p = null,
        b,
...
function Dr(s, t) {
    ...
    if (i === !0) return Ko(s, [{ start: r, end: a, loop: o }], e, t);
    let l = a < r ? a + n : a,
        c = !!s._fullLoop && r === 0 && a === n - 1;
    return Ko(s, Bh(e, r, l, c), e, t);
}
function Ko(s, t, e, i) {
    return !i || !i.setContext || !e ? t : Hh(s, t, e, i);
}
function Hh(s, t, e, i) {
...
var Wn = class {
    ...
    Bn = class {
        constructor(t, e, i, n) {
            ...
            let r = ze([t.from, o, n]);
            ((this._active = !0),
                (this._fn = t.fn || Uh[t.type || typeof r]),
...
function Er(s, t) {
    ...
    for (let f = 0; f < u; ++f) {
        ...
        ((d = b[c] = Qh(n, h, m)),
            (d[a] = p),
            (d._top = Ir(d, r, !0, i.type)),
            (d._bottom = Ir(d, r, !1, i.type)));
...
var An = (s) => s === 'reset' || s === 'none',
    Lr = (s, t) => (t ? s : Object.assign({}, s)),
    su = (s, t, e) =>
        s && !t.hidden && t._stacked && { keys: Da(e, !0), values: null },
    ut = class {
        constructor(t, e) {
            ((this.chart = t),
                (this._ctx = t.ctx),
        ...
        linkScales() {
            let t = this.chart,
                ...
                o = (e.xAxisID = P(i.xAxisID, Pn(t, 'x'))),
                r = (e.yAxisID = P(i.yAxisID, Pn(t, 'y'))),
                a = (e.rAxisID = P(i.rAxisID, Pn(t, 'r'))),
                l = e.indexAxis,
        ...
        _destroy() {
            let t = this._cachedMeta;
            (this._data && an(this._data, this), t._stacked && ys(t));
        }
        _dataCheck() {
            ...
            if (E(e)) {
                ...
                (e && Object.isExtensible(e) && hr(e, this),
                    (this._syncList = []),
                    (this._data = e));
            }
        }
        ...
        buildOrUpdateElements(t) {
            ...
            ((e._stacked = Cn(e.vScale, e)),
                e.stack !== i.stack && ((n = !0), ys(e), (e.stack = i.stack)),
                this._resyncElements(t),
                (n || o !== e._stacked) &&
                    (Er(this, e._parsed), (e._stacked = Cn(e.vScale, e))));
        }
        configure() {
        ...
        _update(t) {
            ...
            (this.update(t || 'default'),
                (e._clip = Gh(
                    P(
                        this.options.clip,
                        qh(e.xScale, e.yScale, this.getMaxOverflow()),
                    ),
                )));
        }
        update(t) {}
        draw() {
            let t = this._ctx,
                ...
                h;
            for (
                i.dataset && i.dataset.draw(t, o, a, l), h = a;
                h < a + l;
                ++h
            ) {
                let u = n[h];
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                ((o = r.$context || (r.$context = eu(this.getContext(), t, r))),
        ...
        _resolveElementOptions(t, e = 'default', i) {
            let n = e === 'active',
                ...
                r = t + '-' + e,
                a = o[r],
                l = this.enableOptionSharing && Ee(i);
            if (a) return Lr(a, l);
            ...
            return (
                m.$shared &&
                    ((m.$shared = l), (o[r] = Object.freeze(Lr(m, l)))),
                m
            );
        }
...
function iu(s, t) {
    if (!s._cache.$bar) {
        ...
        s._cache.$bar = ln(i.sort((n, o) => n - o));
    }
    return s._cache.$bar;
}
function nu(s) {
    let t = s.iScale,
        ...
        l = () => {
            r === 32767 ||
                r === -32768 ||
                (Ee(a) && (i = Math.min(i, Math.abs(r - a) || i)), (a = r));
        };
...
function Ca(s, t, e, i) {
    return (H(s) ? au(s, t, e, i) : (t[e.axis] = e.parse(s, i)), t);
}
function Fr(s, t, e, i) {
    let n = s.iScale,
        o = s.vScale,
...
function hu(s, t, e, i) {
    ...
    let { start: r, end: a, reverse: l, top: c, bottom: h } = cu(s);
    (n === 'middle' &&
        e &&
...
function Rr(s, t, e, i) {
    return (i ? ((s = uu(s, t, e)), (s = Nr(s, e, t))) : (s = Nr(s, t, e)), s);
}
function uu(s, t, e) {
...
function du(s, { inflateAmount: t }, e) {
...
var We = class extends ut {
        ...
        for (let f = e; f < e + i; f++) {
            let g = this.getParsed(f),
                ...
                y = {
                    ...
                    base: m.base,
                    enableBorderRadius:
                        !b || In(g._custom) || r === b._top || r === b._bottom,
                    x: c ? m.head : p.center,
                    y: c ? p.center : m.head,
    ...
    _calculateBarValuePixels(t) {
        ...
        if (b === e.getPixelForValue(a)) {
            let y = (St(m) * e.getLineWidthForValue(a)) / 2;
            ((b += y), (m -= y));
        }
...
function fu(s, t, e) {
    ...
    if (t < $) {
        let a = s,
            ...
            d = Math.sin(l),
            f = (_, w, x) =>
                Fe(_, a, l, !0) ? 1 : Math.max(w, w * e, x, x * e),
            g = (_, w, x) =>
                Fe(_, a, l, !0) ? -1 : Math.min(w, w * e, x, x * e),
            m = f(0, c, u),
            p = f(q, h, d),
            b = g(F, c, u),
            y = g(F + q, h, d);
...
var jt = class extends ut {
    ...
    update(t) {
        let e = this.chart,
            ...
            l = Math.min(er(this.options.cutout, a), 1),
            c = this._getRingWeight(this.index),
            { circumference: h, rotation: u } = this._getRotationExtents(),
            { ratioX: d, ratioY: f, offsetX: g, offsetY: m } = fu(u, h, l),
            p = (i.width - r) / d,
            b = (i.height - r) / f,
            y = Math.max(Math.min(p, b) / 2, 0),
            _ = tn(this.options.radius, y),
            w = Math.max(_ * l, 0),
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            o = Re(e._parsed[t], i.options.locale);
...
var He = class extends ut {
    ...
    updateElements(t, e, i, n) {
        let o = n === 'reset',
            ...
            p = fe(g) ? g : Number.POSITIVE_INFINITY,
        ...
        for (let x = 0; x < _; ++x) {
            ...
            let M = this.getParsed(x),
                T = I(M[f]),
                C = (S[d] = r.getPixelForValue(M[d], x)),
                A = (S[f] =
                    o || T
                        ? a.getBasePixel()
                        : a.getPixelForValue(
...
var xe = class extends ut {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            o = Re(e._parsed[t].r, i.options.locale);
        return { label: n[t] || '', value: o };
    }
    parseObjectData(t, e, i, n) {
        return wn.bind(this)(t, e, i, n);
    }
    update(t) {
        let e = this._cachedMeta.data;
...
var je = class extends ut {
    ...
    updateElements(t, e, i, n) {
        let o = n === 'reset',
            ...
            b = fe(m) ? m : Number.POSITIVE_INFINITY,
...
function bu(s, t, e, i) {
    let n = [];
    function o(r, a, l) {
        let { startAngle: c, endAngle: h } = r.getProps(
                ['startAngle', 'endAngle'],
                i,
            ),
            { angle: u } = rn(r, { x: t.x, y: t.y });
        Fe(u, c, h) && n.push({ element: r, datasetIndex: a, index: l });
    }
    return (Ls(s, e, t, o), n);
}
        ...
        modes: {
            index(s, t, e, i) {
                let n = ee(t, s),
                    ...
                    a = e.intersect ? En(s, n, o, i, r) : Ln(s, n, o, !1, i, r),
                    l = [];
                return a.length
            ...
            nearest(s, t, e, i) {
                let n = ee(t, s),
                    o = e.axis || 'xy',
                    r = e.includeInvisible || !1;
                return Ln(s, n, o, e.intersect, i, r);
            },
            x(s, t, e, i) {
                let n = ee(t, s);
                return zr(s, n, 'x', e.intersect, i);
            },
            y(s, t, e, i) {
                let n = ee(t, s);
                return zr(s, n, 'y', e.intersect, i);
            },
        },
    },
    Pa = ['left', 'top', 'right', 'bottom'];
function xs(s, t) {
    return s.filter((e) => e.pos === t);
}
function Vr(s, t) {
    return s.filter((e) => Pa.indexOf(e.pos) === -1 && e.box.axis === t);
}
function _s(s, t) {
    return s.sort((e, i) => {
        let n = t ? i : e,
...
function Su(s, t, e, i) {
    ...
    let a = Math.max(0, t.outerWidth - Wr(r, s, 'left', 'right')),
        l = Math.max(0, t.outerHeight - Wr(r, s, 'top', 'bottom')),
        c = a !== s.w,
        h = l !== s.h;
    return (
        (s.w = a),
...
function Ss(s, t, e, i) {
    ...
    for (o = 0, r = s.length, c = 0; o < r; ++o) {
        ...
        let { same: u, other: d } = Su(t, e, a, i);
        ((c |= u && n.length), (h = h || d), l.fullSize || n.push(a));
    }
    return (c && Ss(n, t, e, i)) || h;
}
...
var rt = {
        ...
        update(s, t, e, i) {
            if (!s) return;
            let n = nt(s.options.layout.padding),
            ...
            (Ss(a.fullSize, f, u, g),
                Ss(l, f, u, g),
                Ss(c, f, u, g) && Ss(l, f, u, g),
                Mu(f),
                Br(a.leftAndTop, f, u, g),
                (f.x += f.w),
                (f.y += f.h),
                Br(a.rightAndBottom, f, u, g),
                (s.chartArea = {
                    left: f.left,
                    top: f.top,
                    right: f.left + f.w,
...
var Ia = Sr ? { passive: !0 } : !1;
function Cu(s, t, e) {
    s && s.addEventListener(t, e, Ia);
}
function Pu(s, t, e) {
    s && s.canvas && s.canvas.removeEventListener(t, e, Ia);
}
function Au(s, t) {
    let e = Tu[s.type] || s.type,
        { x: i, y: n } = ee(s, t);
    return {
        type: e,
        chart: t,
...
function Iu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((o) => {
            let r = !1;
            for (let a of o)
                ((r = r || ki(a.addedNodes, i)),
                    (r = r && !ki(a.removedNodes, i)));
            r && e();
        });
...
function Lu(s, t) {
    (As.size || window.addEventListener('resize', Ea), As.set(s, t));
}
function Fu(s) {
    (As.delete(s), As.size || window.removeEventListener('resize', Ea));
}
function Ru(s, t, e) {
    let i = s.canvas,
        n = i && hi(i);
...
var jn = class extends wi {
    ...
    addEventListener(t, e, i) {
        ...
        let n = t.$proxies || (t.$proxies = {}),
            r = { attach: Iu, detach: Eu, resize: Ru }[e] || Nu;
        n[e] = r(t, e, i);
    }
    removeEventListener(t, e) {
        let i = t.$proxies || (t.$proxies = {}),
            n = i[e];
        if (!n) return;
        ((({ attach: Fn, detach: Fn, resize: Fn })[e] || Pu)(t, e, n),
            (i[e] = void 0));
    }
    getDevicePixelRatio() {
...
function Vu(s, t) {
    let e = s.options.ticks,
        ...
        o = e.major.enabled ? Hu(t) : [],
        r = o.length,
        a = o[0],
        l = o[r - 1],
        c = [];
    if (r > n) return ($u(t, c, o, r / n), c);
    let h = Bu(o, t, n);
    if (r > 0) {
        let u,
            d,
            f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
        for (fi(t, c, h, I(f) ? 0 : a - f, a), u = 0, d = r - 1; u < d; u++)
            fi(t, c, h, o[u], o[u + 1]);
        return (fi(t, c, h, l, I(f) ? t.length : l + f), c);
    }
    return (fi(t, c, h), c);
}
function Wu(s) {
...
var Uu = (s) => (s === 'left' ? 'right' : s === 'right' ? 'left' : s),
    jr = (s, t, e) => (t === 'top' || t === 'left' ? s[t] + e : s[t] - e),
    Ur = (s, t) => Math.min(t || s, s);
function Yr(s, t) {
    let e = [],
        i = s.length / t,
        n = s.length,
...
function Xu(s, t, e) {
    let i = ni(s);
    return (((e && t !== 'right') || (!e && t === 'right')) && (i = Uu(i)), i);
}
function Ju(s, t, e, i) {
...
var we = class s extends dt {
        ...
        update(t, e, i) {
            ...
            (this.beforeUpdate(),
                ...
                this._dataLimitsCached ||
                    ...
                    (this._range = br(this, o, n)),
                    (this._dataLimitsCached = !0)),
                this.beforeBuildTicks(),
                (this.ticks = this.buildTicks() || []),
                this.afterBuildTicks());
            let l = a < this.ticks.length;
            (this._convertTicksToLabels(l ? Yr(this.ticks, a) : this.ticks),
                this.configure(),
        ...
        calculateLabelRotation() {
            let t = this.options,
                e = t.ticks,
                i = Ur(this.ticks.length, t.ticks.maxTicksLimit),
                n = e.minRotation || 0,
                o = e.maxRotation,
                r = n,
                a,
            ...
            ((a = t.offset ? this.maxWidth / i : f / (i - 1)),
                u + 6 > a &&
                    ...
                    (l =
                        ...
                        ws(t.grid) -
                        e.padding -
                        Zr(t.title, this.chart.options.font)),
                    (c = Math.sqrt(u * u + d * d)),
                    (r = si(
                        Math.min(
        ...
        fit() {
            let t = { width: 0, height: 0 },
                ...
                a = this.isHorizontal();
            if (r) {
                let l = Zr(n, e.options.font);
                if (
                    (a
                        ? ((t.width = this.maxWidth), (t.height = ws(o) + l))
                        : ((t.height = this.maxHeight), (t.width = ws(o) + l)),
        ...
        _computeLabelSizes(t, e, i) {
            ...
            for (u = 0; u < e; u += l) {
                if (
                    ...
                    ((_ = fs(n, b.data, b.gc, _, g)), (w = y));
                else if (H(g))
                    for (d = 0, f = g.length; d < f; ++d)
                        ((x = g[d]),
                            !I(x) &&
                                !H(x) &&
                                ((_ = fs(n, b.data, b.gc, _, x)), (w += y)));
                (r.push(_),
                    a.push(w),
                    (c = Math.max(_, c)),
                    (h = Math.max(w, h)));
        ...
        getPixelForDecimal(t) {
            ...
            return rr(this._alignToPixels ? Kt(this.chart, e, 0) : e);
        }
        ...
        getContext(t) {
            ...
            if (t >= 0 && t < e.length) {
                let i = e[t];
                return i.$context || (i.$context = Gu(this.getContext(), t, i));
            }
            return (
                this.$context ||
                (this.$context = qu(this.chart.getContext(), this))
            );
        }
        _tickSize() {
        ...
        _computeGridLineItems(t) {
            ...
            if (r === 'top')
                ...
                if (r === 'center') y = b((t.top + t.bottom) / 2 + 0.5);
                    ...
                    let U = Object.keys(r)[0],
                        G = r[U];
                    y = b(this.chart.scales[U].getPixelForValue(G));
                }
                ((A = t.top), (et = t.bottom), (S = y + p), (T = S + d));
            } else if (e === 'y') {
        ...
        _computeLabelItems(t) {
            ...
            for (b = 0, y = a.length; b < y; ++b) {
                ((_ = a[b]), (w = _.label));
                let V = o.setContext(this.getContext(b));
                ...
                let U = A / 2,
                    G = V.color,
                    vt = V.textStrokeColor,
                    ot = V.textStrokeWidth,
                    Oe = S;
                r
                    ? ((x = M),
                      S === 'inner' &&
    ...
    Ze = class {
        ...
        unregister(t) {
            ...
            (i in e && delete e[i],
                n &&
                    i in j[n] &&
                    (delete j[n][i], this.override && delete Jt[i]));
        }
    };
function Ku(s, t, e) {
    let i = Pe(Object.create(null), [e ? j.get(e) : {}, j.get(t), s.defaults]);
    (j.set(t, i),
        s.defaultRoutes && Qu(t, s.defaultRoutes),
...
var Un = class {
        constructor() {
            ((this.controllers = new Ze(ut, 'datasets', !0)),
                (this.elements = new Ze(dt, 'elements')),
                (this.plugins = new Ze(Object, 'plugins')),
                (this.scales = new Ze(we, 'scales')),
    ...
    Yn = class {
        ...
        _notifyStateChanges(t) {
            let e = this._oldCache || [],
                ...
                n = (o, r) =>
                    o.filter(
                        (a) => !r.some((l) => a.plugin.id === l.plugin.id),
                    );
...
function ed(s) {
    let t = {},
        e = [],
        i = Object.keys(Lt.plugins.items);
    for (let o = 0; o < i.length; o++) e.push(Lt.getPlugin(i[o]));
    let n = s.plugins || [];
...
function id(s, { plugins: t, localIds: e }, i, n) {
    let o = [],
        r = s.getContext();
    for (let a of t) {
        let l = a.id,
        ...
        c !== null &&
            o.push({
                plugin: a,
                options: nd(s.config, { plugin: a, local: e[l] }, c, r),
            });
    }
    return o;
}
function nd(s, { plugin: t, local: e }, i, n) {
...
function ld(s, t) {
    if (t.data && t.data.datasets) {
        ...
        if (e.length) return Gr(s, 'x', e[0]) || Gr(s, 'y', e[0]);
    }
    return {};
}
function cd(s, t) {
    let e = Jt[s.type] || { scales: {} },
        i = t.scales || {},
        n = Zn(s.type, t),
    ...
    return (
        Object.keys(i).forEach((r) => {
            ...
            let l = qn(r, a, ld(r, s), j.scales[a.type]),
                c = rd(l, n),
                h = e.scales || {};
...
function La(s) {
    ...
    ((t.plugins = P(t.plugins, {})), (t.scales = cd(s, t)));
}
function Fa(s) {
    return (
        (s = s || {}),
...
function hd(s) {
    return ((s = s || {}), (s.data = Fa(s.data)), La(s), s);
}
var Xr = new Map(),
    Ra = new Set();
function gi(s, t) {
    let e = Xr.get(s);
    return (e || ((e = t()), Xr.set(s, e), Ra.add(e)), e);
}
var ks = (s, t, e) => {
        let i = Wt(t, e);
        i !== void 0 && s.add(i);
    ...
    Gn = class {
        ...
        getOptionScopes(t, e, i) {
            ...
            let l = new Set();
            e.forEach((h) => {
                (t && (l.add(t), h.forEach((u) => ks(l, t, u))),
                    h.forEach((u) => ks(l, n, u)),
                    h.forEach((u) => ks(l, Jt[o] || {}, u)),
                    h.forEach((u) => ks(l, j, u)),
                    h.forEach((u) => ks(l, oi, u)));
            });
            let c = Array.from(l);
            return (
        ...
        chartOptionScopes() {
            ...
            return [t, Jt[e] || {}, j.datasets[e] || {}, { type: e }, j, oi];
        }
        resolveNamedOptions(t, e, i, n = ['']) {
            let o = { $shared: !0 },
                { resolver: r, subPrefixes: a } = Jr(this._resolverCache, t, n),
                l = r;
            if (dd(r, e)) {
        ...
        createResolver(t, e, i = [''], n) {
            let { resolver: o } = Jr(this._resolverCache, t, i);
            return E(e) ? de(o, e, void 0, n) : o;
        }
    };
function Jr(s, t, e) {
    let i = s.get(t);
...
var ud = (s) => E(s) && Object.getOwnPropertyNames(s).some((t) => zt(s[t]));
function dd(s, t) {
    let { isScriptable: e, isIndexable: i } = yn(s);
    for (let n of t) {
        let o = e(n),
            r = i(n),
            a = (r || o) && s[n];
        if ((o && (zt(a) || ud(a))) || (r && H(a))) return !0;
    }
    return !1;
}
var fd = '4.5.1',
    gd = ['top', 'bottom', 'left', 'right', 'chartArea'];
function Kr(s, t) {
    return s === 'top' || s === 'bottom' || (gd.indexOf(s) === -1 && t === 'x');
}
function Qr(s, t) {
    return function (e, i) {
...
var yt = class {
    ...
    constructor(t, e) {
        ...
        ((this.platform = new (i.platform || zu(n))()),
        ...
        if (
            ...
            (this.scales = {}),
            (this._plugins = new Yn()),
            (this.$proxies = {}),
            (this._hiddenIndices = {}),
            (this.attached = !1),
            (this._animationsDisabled = void 0),
            (this.$context = void 0),
            (this._doResize = ur((u) => this.update(u), r.resizeDelay || 0)),
            (this._dataChanges = []),
            (xi[this.id] = this),
            !a || !l)
        ) {
        ...
        (Ht.listen(this, 'complete', ta),
            Ht.listen(this, 'progress', md),
            this._initialize(),
        ...
        (e &&
            ...
            z(o, (r) => {
                let a = r.options,
                    ...
                    h = P(a.type, r.dtype);
                ((a.position === void 0 ||
                    Kr(a.position, c) !== Kr(r.dposition)) &&
    ...
    _updateMetasets() {
        ...
        this._sortedMetasets = t.slice(0).sort(Qr('order', 'index'));
    }
    ...
    buildOrUpdateControllers() {
        ...
        for (
            ...
            if (
                ...
                (r.type = a),
                (r.indexAxis = o.indexAxis || Zn(a, this.options)),
                (r.order = o.order || 0),
                (r.index = i),
                (r.label = '' + o.label),
    ...
    _checkEventBindings() {
        let t = this.options,
            ...
            i = new Set(t.events);
        (!en(e, i) || !!this._responsiveListeners !== t.responsive) &&
    ...
    _getUniformDataChanges() {
        ...
        let e = this.data.datasets.length,
            ...
            n = i(0);
        for (let o = 1; o < e; o++) if (!en(n, i(o))) return;
        return Array.from(n)
            .map((o) => o.split(','))
...
function wd(s, t, e, i) {
    let n = _d(s.options.borderRadius),
        o = (e - t) / 2,
        r = Math.min(o, (i * t) / 2),
        a = (l) => {
...
function vi(s, t, e, i, n, o) {
    ...
    if ((s.beginPath(), o)) {
        ...
        s.moveTo(r, a);
        let V = Math.cos(T) * u + r,
            U = Math.sin(T) * u + a;
        s.lineTo(V, U);
        let G = Math.cos(C) * u + r,
            vt = Math.sin(C) * u + a;
        s.lineTo(G, vt);
    }
    s.closePath();
}
function kd(s, t, e, i, n) {
...
function vd(s, t, e, i, n) {
    let { fullCircles: o, startAngle: r, circumference: a, options: l } = t,
        {
            borderWidth: c,
            borderJoinStyle: h,
            borderDash: u,
    ...
    (g && xd(s, t, m),
        l.selfJoin && m - r >= F && f === 0 && h !== 'miter' && yd(s, t, m),
...
var be = class extends dt {
    ...
    inRange(e, i, n) {
        let o = this.getProps(['x', 'y'], n),
            { angle: r, distance: a } = rn(o, { x: e, y: i }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
...
function Od(s, t, e, i) {
    let { points: n, options: o } = t,
        { count: r, start: a, loop: l, ilen: c } = Va(n, e, i),
        h = Md(o),
    ...
    for (f = 0; f <= c; ++f)
        ((g = n[(a + (d ? c - f : f)) % r]),
            !g.skip &&
                ...
                (m = g)));
    return (
        l && ((g = n[(a + (d ? c : 0)) % r]), h(s, m, g, d, o.stepped)), !!l
    );
}
function Td(s, t, e, i) {
    let n = t.points,
        { count: o, start: r, ilen: a } = Va(n, e, i),
...
var Ad = typeof Path2D == 'function';
function Id(s, t, e, i) {
    Ad && !t.options.segment ? Cd(s, t, e, i) : Pd(s, t, e, i);
}
var Ft = class extends dt {
    ...
    updateControlPoints(t, e) {
        ...
        if (
            ...
            (kr(this._points, i, t, n, e), (this._pointsUpdated = !0));
        }
    }
    set points(t) {
        ((this._points = t),
    ...
    get segments() {
        return (
            this._segments || (this._segments = Dr(this, this.options.segment))
        );
    }
    first() {
        let t = this.segments,
    ...
    interpolate(t, e) {
        let i = this.options,
            n = t[e],
            o = this.points,
            r = Tn(this, { property: e, start: n, end: n });
        if (!r.length) return;
        let a = [],
            l = Dd(i),
            c,
    ...
    draw(t, e, i, n) {
        ...
        ((this.points || []).length &&
            o.borderWidth &&
            (t.save(), Id(t, this, i, n), t.restore()),
            this.animated &&
...
var Ue = class extends dt {
    ...
    inXRange(e, i) {
        return ia(this, e, 'x', i);
    }
    inYRange(e, i) {
        return ia(this, e, 'y', i);
    }
    getCenterPoint(e) {
...
function Ed(s, t, e) {
    let i = s.options.borderWidth,
        ...
        o = bn(i);
    return {
        t: se(n.top, o.top, 0, e),
        r: se(n.right, o.right, 0, t),
        b: se(n.bottom, o.bottom, 0, e),
        l: se(n.left, o.left, 0, t),
    };
}
function Ld(s, t, e) {
    let { enableBorderRadius: i } = s.getProps(['enableBorderRadius']),
        ...
        l = i || E(n);
    return {
        topLeft: se(!l || a.top || a.left, o.topLeft, 0, r),
        topRight: se(!l || a.top || a.right, o.topRight, 0, r),
        bottomLeft: se(!l || a.bottom || a.left, o.bottomLeft, 0, r),
        bottomRight: se(!l || a.bottom || a.right, o.bottomRight, 0, r),
    };
}
function Fd(s) {
    let t = Wa(s),
...
var zd = Object.freeze({
    ...
    na = Jn.map((s) => s.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
function Ba(s) {
    return Jn[s % Jn.length];
}
function Ha(s) {
    return na[s % na.length];
}
function Vd(s, t) {
    return ((s.borderColor = Ba(t)), (s.backgroundColor = Ha(t)), ++t);
}
function Wd(s, t) {
    return ((s.backgroundColor = s.data.map(() => Ba(t++))), t);
}
function Bd(s, t) {
...
function qd(s, t) {
    ...
    return (
        l && (i = K(Ct(t, o.axis, r).lo, 0, e - 1)),
        c ? (n = K(Ct(t, o.axis, a).hi + 1, i, e) - i) : (n = e - i),
        { start: i, count: n }
    );
}
var Gd = {
...
function Xd(s, t, e) {
    ...
    for (let a of i) {
        ...
        let u = Tn(t, h);
        for (let d of u) {
            let f = Kn(e, o[d.start], o[d.end], d.loop),
                g = On(a, n, f);
            for (let m of g)
                r.push({
                    source: m,
                    target: d,
                    start: { [e]: aa(h, f, 'start', Math.max) },
                    end: { [e]: aa(h, f, 'end', Math.min) },
                });
        }
    }
    return r;
...
function of(s) {
    let { scale: t, index: e, line: i } = s,
        ...
        r = i.points,
        a = rf(t, e);
    a.push(ja({ x: null, y: t.bottom }, i));
    for (let l = 0; l < o.length; l++) {
        let c = o[l];
        for (let h = c.start; h <= c.end; h++) af(n, r[h], a);
    }
    return new Ft({ points: n, options: {} });
}
function rf(s, t) {
    let e = [],
...
function af(s, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
        let o = e[n],
            { first: r, last: a, point: l } = lf(o, t, 'x');
        if (!(!l || (r && a))) {
            if (r) i.unshift(l);
...
function cf(s) {
    ...
    if (Z(e)) return hf(t, e);
    if (e === 'stack') return of(s);
    if (e === 'shape') return !0;
    let n = uf(s);
    return n instanceof Si ? n : ja(n, i);
}
function hf(s, t) {
...
function uf(s) {
    return (s.scale || {}).getPointPositionForValue ? ff(s) : df(s);
}
function df(s) {
    ...
    (o !== n &&
        (c === 'x'
            ...
            : c === 'y' &&
              ...
              ha(s, i, r.right),
              (h = n))),
        Vn(s, { line: e, target: i, color: h, scale: a, property: c, clip: l }),
        s.restore());
}
function ca(s, t, e) {
...
function Vn(s, t) {
    let { line: e, target: i, property: n, color: o, scale: r, clip: a } = t,
        l = Xd(e, i, n);
...
var pf = {
        ...
        afterDatasetsUpdate(s, t, e) {
            ...
            for (r = 0; r < i; ++r)
                ((l = n[r]),
                    !(!l || l.fill === !1) && (l.fill = Kd(n, r, e.propagate)));
        },
        beforeDraw(s, t, e) {
    ...
    Mi = class extends dt {
        ...
        _fitRows(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((g, m) => {
                    let p = i + e / 2 + o.measureText(g.text).width;
        ...
        _fitCols(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((p, b) => {
                    let { itemWidth: y, itemHeight: _ } = yf(i, e, o, p, n);
                    (b > 0 &&
                        f + _ + 2 * a > h &&
                        ((u += d + a),
        ...
        adjustHitBoxes() {
            ...
            let t = this._computeTitleHeight(),
                ...
                r = ge(o, this.left, this.width);
            if (this.isHorizontal()) {
                let a = 0,
                    l = it(i, this.left + n, this.right - this.lineWidths[a]);
                for (let c of e)
                    (a !== c.row &&
                        ((a = c.row),
                        (l = it(
        ...
        _draw() {
            let { options: t, columnSizes: e, lineWidths: i, ctx: n } = this,
                { align: o, labels: r } = t,
                a = j.color,
                l = ge(t.rtl, this.left, this.width),
                c = X(r.font),
                { padding: h } = r,
                u = c.size,
                d = u / 2,
            ...
            (this.drawTitle(),
                ...
                (n.lineWidth = 0.5),
                (n.font = c.string));
            let { boxWidth: g, boxHeight: m, itemHeight: p } = da(r, u),
                b = function (k, S, M) {
                    ...
                    if (
                        ...
                        let C = {
                            ...
                            A = l.xPlus(k, g / 2),
                            L = S + d;
                        pn(n, C, A, L, r.pointStyleWidth && g);
                    } else {
            ...
            (this.legendItems.forEach((k, S) => {
                ...
                (l.setWidth(this.width),
                    _
                        ? S > 0 &&
                          ...
                          f.line++,
                          (A = f.x =
                              it(o, this.left + h, this.right - i[f.line])))
                        : S > 0 &&
                          L + x > this.bottom &&
                ...
                if (
                    (b(et, L, k),
                    (A = dr(T, A + g + d, _ ? A + C : this.right, t.rtl)),
                    y(l.x(A), L, k),
                    _)
                )
                    f.x += C + h;
        ...
        drawTitle() {
            let t = this.options,
                ...
                n = nt(e.padding);
            if (!e.display) return;
            let o = ge(t.rtl, this.left, this.width),
                r = this.ctx,
                a = e.position,
                l = i.size / 2,
                c = n.top + l,
...
function _f(s, t, e) {
    let i = s;
    return (typeof t.text != 'string' && (i = Ua(t, e)), i);
}
function Ua(s, t) {
...
var kf = {
        ...
        _element: Mi,
        start(s, t, e) {
            let i = (s.legend = new Mi({ ctx: s.ctx, options: e, chart: s }));
    ...
    Is = class extends dt {
        ...
        update(t, e) {
            ...
            let n = H(i.text) ? i.text.length : 1;
            this._padding = nt(i.padding);
            let o = n * X(i.font).lineHeight + this._padding.height;
...
function vf(s, t) {
    let e = new Is({ ctx: s.ctx, options: t, chart: s });
...
var Sf = {
    ...
    Mf = {
        id: 'subtitle',
        start(s, t, e) {
            let i = new Is({ ctx: s.ctx, options: e, chart: s });
...
function ga(s, t, e) {
    let i = e.yAlign || t.yAlign || Tf(s, e);
...
function ma(s, t, e, i) {
    let { caretSize: n, caretPadding: o, cornerRadius: r } = s,
        { xAlign: a, yAlign: l } = e,
        c = n + o,
        { topLeft: h, topRight: u, bottomLeft: d, bottomRight: f } = te(r),
        g = Pf(t, a),
        m = Af(t, l, c);
    return (
        l === 'center'
...
function lt(s, t, e, i) {
    let n = s[t].call(e, i);
    return typeof n > 'u' ? Ya[t].call(e, i) : n;
}
var Ps = class extends dt {
    ...
    getTitle(t, e) {
        let { callbacks: i } = e,
            ...
            a = [];
        return ((a = Et(a, $t(n))), (a = Et(a, $t(o))), (a = Et(a, $t(r))), a);
    }
    getBeforeBody(t, e) {
        return pa(lt(e.callbacks, 'beforeBody', this, t));
    }
    getBody(t, e) {
        let { callbacks: i } = e,
            n = [];
        return (
            z(t, (o) => {
                let r = { before: [], lines: [], after: [] },
                    a = ba(i, o);
                (Et(r.before, $t(lt(a, 'beforeLabel', this, o))),
                    Et(r.lines, lt(a, 'label', this, o)),
                    Et(r.after, $t(lt(a, 'afterLabel', this, o))),
                    n.push(r));
            }),
            n
        );
    ...
    getAfterBody(t, e) {
        return pa(lt(e.callbacks, 'afterBody', this, t));
    }
    getFooter(t, e) {
        let { callbacks: i } = e,
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
            ...
            let a = Ms[i.position].call(this, n, this._eventPosition);
            ...
            let l = (this._size = fa(this, i)),
                c = Object.assign({}, a, l),
                h = ga(this.chart, i, c),
                u = ma(i, c, h, this.chart);
    ...
    drawTitle(t, e, i) {
        let n = this.title,
            ...
            l;
        if (o) {
            let c = ge(i.rtl, this.x, this.width);
            for (
    ...
    _drawColorBox(t, e, i, n, o) {
        ...
        if (o.usePointStyle) {
            ...
            Object.values(b).some((y) => y !== 0)
                ? (t.beginPath(),
                  (t.fillStyle = o.multiKeyBackground),
                  Ne(t, { x: m, y: g, w: c, h: l, radius: b }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = r.backgroundColor),
                  t.beginPath(),
                  Ne(t, { x: p, y: g + 1, w: c - 2, h: l - 2, radius: b }),
                  t.fill())
                : ((t.fillStyle = o.multiKeyBackground),
                  t.fillRect(m, g, c, l),
    ...
    drawFooter(t, e, i) {
        let n = this.footer,
            ...
            a;
        if (o) {
            let l = ge(i.rtl, this.x, this.width);
            for (
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            o = i && i.y;
        if (n || o) {
            let r = Ms[t.position].call(
                this,
                this._active,
                this._eventPosition,
            );
            if (!r) return;
            let a = (this._size = fa(this, t)),
...
var Ef = {
        ...
        positioners: Ms,
        afterInit(s, t, e) {
            e && (s.tooltip = new Ps({ chart: s, options: e }));
        },
        beforeUpdate(s, t, e) {
...
function Rf(s, t, e, i) {
    let n = s.indexOf(t);
    if (n === -1) return Ff(s, t, e, i);
    let o = s.lastIndexOf(t);
    return n !== o ? e : n;
}
var Nf = (s, t) => (s === null ? null : K(Math.round(s), 0, t));
function ya(s) {
    ...
    parse(t, e) {
        ...
        return (
            (e =
                isFinite(e) && i[e] === t
                    ? e
                    : Rf(i, t, P(e, t), this._addedLabels)),
            Nf(e, i.length - 1)
        );
    }
    determineDataLimits() {
...
(v(Os, 'id', 'category'), v(Os, 'defaults', { ticks: { callback: ya } }));
function zf(s, t) {
    let e = [],
        {
            bounds: n,
        ...
        b && y && o && or((a - r) / o, x / 1e3)
            ...
            : _
              ? ((S = b ? r : S),
                ...
                (x = (M - S) / T))
              : ((T = (M - S) / x),
                Le(T, Math.round(T), x / 1e3)
                    ? (T = Math.round(T))
                    : (T = Math.ceil(T))));
    let C = Math.max(on(x), on(S));
    ...
    for (
        ...
        (d && S !== r
            ? (e.push({ value: r }),
              S < r && A++,
              Le(Math.round((S + A * x) * k) / k, r, xa(r, w, s)) && A++)
            : S < r && A++);
        A < T;
        ++A
    ) {
    ...
    return (
        y && d && M !== a
            ? e.length && Le(e[e.length - 1].value, a, xa(a, w, s))
...
function xa(s, t, { horizontal: e, minRotation: i }) {
    let n = bt(i),
...
var qe = class extends we {
        ...
        buildTicks() {
            ...
            let n = {
                ...
                r = zf(n, o);
            return (
                t.bounds === 'ticks' && nn(r, this, 'value'),
                t.reverse
                    ? (r.reverse(),
                      (this.start = this.max),
                      (this.end = this.min))
...
function Vf(s, t) {
    ...
    for (; wa(s, t, i) > 10; ) i++;
    for (; wa(s, t, i) < 10; ) i--;
    return Math.min(i, Es(s));
}
function Wf(s, { min: t, max: e }) {
    t = at(s.min, t);
    let i = [],
        n = Es(t),
        o = Vf(t, e),
        ...
        d = at(s.min, Math.round((l + h + u * Math.pow(10, o)) * r) / r);
    for (; d < e; )
        (i.push({ value: d, major: _a(d), significand: u }),
            u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
            u >= 20 && (o++, (u = 2), (r = o >= 0 ? 1 : r)),
            (d = Math.round((l + h + u * Math.pow(10, o)) * r) / r));
    let f = at(s.max, d);
    return (i.push({ value: f, major: _a(f), significand: u }), i);
}
var Ds = class extends we {
    ...
    determineDataLimits() {
        ...
        ((this.min = Z(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
                ...
                !Z(this._userMin) &&
                (this.min =
                    t === pe(this.min, 0) ? pe(this.min, -1) : pe(this.min, 0)),
            this.handleTickRangeOptions());
    }
    handleTickRangeOptions() {
        let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            o = (a) => (i = t ? i : a),
            r = (a) => (n = e ? n : a);
        (i === n && (i <= 0 ? (o(1), r(10)) : (o(pe(i, -1)), r(pe(n, 1)))),
            i <= 0 && o(pe(n, -1)),
            n <= 0 && r(pe(i, 1)),
            (this.min = i),
            (this.max = n));
    ...
    buildTicks() {
        let t = this.options,
            ...
            i = Wf(e, this);
        return (
            t.bounds === 'ticks' && nn(i, this, 'value'),
            t.reverse
...
function Bf(s, t, e) {
    return (
        (e = H(e) ? e : [e]),
        { w: gr(s, t.string, e), h: e.length * t.lineHeight }
    );
}
...
function Hf(s) {
    let t = {
        ...
        a = r.centerPointLabels ? F / o : 0;
    for (let l = 0; l < o; l++) {
        let c = r.setContext(s.getPointLabelContext(l));
        n[l] = c.padding;
        let h = s.getPointPosition(l, s.drawingArea + n[l], a),
            u = X(c.font),
            d = Bf(s.ctx, u, s._pointLabels[l]);
        i[l] = d;
        let f = st(s.getIndexAngle(l) + a),
            g = Math.round(si(f)),
            m = ka(g, h.x, d.w, 0, 180),
            p = ka(g, h.y, d.h, 90, 270);
        $f(e, t, f, m, p);
    }
    (s.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
        (s._pointLabelItems = Yf(s, i, n)));
}
...
function jf(s, t, e) {
    let i = s.drawingArea,
        ...
        l = s.getPointPosition(t, i + n + r, o),
        c = Math.round(si(st(l.angle + q))),
        h = Gf(l.y, a.h, c),
        u = Zf(c),
        d = qf(l.x, a.w, u);
    return {
...
function Uf(s, t) {
    if (!t) return !0;
    let { left: e, top: i, right: n, bottom: o } = s;
    return !(
        Pt({ x: e, y: i }, t) ||
        Pt({ x: e, y: o }, t) ||
        Pt({ x: n, y: i }, t) ||
...
function Yf(s, t, e) {
    let i = [],
        ...
        l = { extra: Qn(o) / 2, additionalAngle: r ? F / n : 0 },
        c;
    for (let h = 0; h < n; h++) {
        ((l.padding = e[h]), (l.size = t[h]));
        let u = jf(s, h, l);
        (i.push(u),
            a === 'auto' && ((u.visible = Uf(u, c)), u.visible && (c = u)));
    }
    return i;
}
function Zf(s) {
...
function Xf(s, t, e) {
    let { left: i, top: n, right: o, bottom: r } = e,
        { backdropColor: a } = t;
    if (!I(a)) {
        let l = te(t.borderRadius),
...
function Jf(s, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
        let o = s._pointLabelItems[n];
        if (!o.visible) continue;
        let r = i.setContext(s.getPointLabelContext(n));
        Xf(e, r, o);
        let a = X(r.font),
            { x: l, y: c, textAlign: h } = o;
        Qt(e, s._pointLabels[n], l, c + a.lineHeight / 2, a, {
            color: r.color,
            textAlign: h,
            textBaseline: 'middle',
        });
...
var ye = class extends qe {
    ...
    setDimensions() {
        let t = (this._padding = nt(Qn(this.options) / 2)),
    ...
    getIndexAngle(t) {
        let e = $ / (this._pointLabels.length || 1),
...
var _e = class extends we {
    ...
    init(t, e = {}) {
        let i = t.time || (t.time = {}),
            n = (this._adapter = new to._date(t.adapters.date));
        (n.init(e),
    ...
    parse(t, e) {
        return t === void 0 ? null : Sa(this, t);
    }
    beforeLayout() {
        (super.beforeLayout(),
            (this._cache = { data: [], labels: [], all: [] }));
        ...
        return (
            (this._unit =
                ...
                (i.autoSkip
                    ...
                    : tg(this, a.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
    ...
    _generate() {
        let t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            r = o.unit || Ma(o.minUnit, e, i, this._getLabelCapacity(e)),
        ...
        for (d = u, f = 0; d < i; d = +t.add(d, a, r), f++) Oa(h, d, g);
        return (
            (d === i || n.bounds === 'ticks' || f === 1) && Oa(h, d, g),
            Object.keys(h)
                .sort(va)
                .map((m) => +m)
        );
    ...
    getLabelTimestamps() {
        ...
        for (e = 0, i = n.length; e < i; ++e) t.push(Sa(this, n[e]));
...
var Yt = class extends Error {},
    ...
    Dt = 'short',
    mt = 'long',
    Ri = { year: O, month: O, day: O },
    Ml = { year: O, month: Dt, day: O },
    ng = { year: O, month: Dt, day: O, weekday: Dt },
    Ol = { year: O, month: mt, day: O },
    Tl = { year: O, month: mt, day: O, weekday: mt },
    Dl = { hour: O, minute: O },
    Cl = { hour: O, minute: O, second: O },
    Pl = { hour: O, minute: O, second: O, timeZoneName: Dt },
    Al = { hour: O, minute: O, second: O, timeZoneName: mt },
    Il = { hour: O, minute: O, hourCycle: 'h23' },
    El = { hour: O, minute: O, second: O, hourCycle: 'h23' },
    Ll = { hour: O, minute: O, second: O, hourCycle: 'h23', timeZoneName: Dt },
    Fl = { hour: O, minute: O, second: O, hourCycle: 'h23', timeZoneName: mt },
    Rl = { year: O, month: O, day: O, hour: O, minute: O },
    Nl = { year: O, month: O, day: O, hour: O, minute: O, second: O },
    zl = { year: O, month: Dt, day: O, hour: O, minute: O },
    Vl = { year: O, month: Dt, day: O, hour: O, minute: O, second: O },
    og = { year: O, month: Dt, day: O, weekday: Dt, hour: O, minute: O },
    Wl = { year: O, month: mt, day: O, hour: O, minute: O, timeZoneName: Dt },
    Bl = {
        year: O,
        month: mt,
        day: O,
    ...
    eo = null,
    Ni = class s extends Me {
        static get instance() {
            return (eo === null && (eo = new s()), eo);
        }
        get type() {
            return 'system';
        }
...
var ag = { year: 0, month: 1, day: 2, era: 3, hour: 4, minute: 5, second: 6 };
function lg(s, t) {
...
var so = new Map(),
    ae = class s extends Me {
        static create(t) {
            let e = so.get(t);
            return (e === void 0 && so.set(t, (e = new s(t))), e);
        }
        static resetCache() {
            (so.clear(), go.clear());
        }
        ...
        offset(t) {
            ...
            let i = rg(this.name),
                [n, o, r, a, l, c, h] = i.formatToParts ? cg(i, e) : lg(i, e);
            a === 'BC' && (n = -Math.abs(n) + 1);
            let d = $i({
                    year: n,
                    month: o,
...
function hg(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = Ga[e];
    return (i || ((i = new Intl.ListFormat(s, t)), (Ga[e] = i)), i);
}
var mo = new Map();
function po(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = mo.get(e);
    return (
        i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), mo.set(e, i)), i
    );
}
var bo = new Map();
function ug(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = bo.get(e);
    return (
        i === void 0 && ((i = new Intl.NumberFormat(s, t)), bo.set(e, i)), i
    );
}
var yo = new Map();
function dg(s, t = {}) {
    let { base: e, ...i } = t,
        ...
        o = yo.get(n);
    return (
        o === void 0 && ((o = new Intl.RelativeTimeFormat(s, t)), yo.set(n, o)),
        o
    );
}
var Rs = null;
...
function jl(s) {
    ...
    return (
        t === void 0 &&
            ((t = new Intl.DateTimeFormat(s).resolvedOptions()), xo.set(s, t)),
        t
    );
}
var _o = new Map();
...
function mg(s) {
    ...
    if (e === -1) return [s];
    {
        let i, n;
        try {
            ((i = po(s).resolvedOptions()), (n = s));
        } catch {
            let l = s.substring(0, e);
            ((i = po(l).resolvedOptions()), (n = l));
        }
...
function xg(s) {
    return s.numberingSystem && s.numberingSystem !== 'latn'
        ...
        : s.numberingSystem === 'latn' ||
              ...
              jl(s.locale).numberingSystem === 'latn';
}
var wo = class {
        constructor(t, e, i) {
                ...
                t.zone.type === 'system'
                    ...
                    : t.zone.type === 'iana'
                      ...
                      : ((n = 'UTC'),
                        ...
                        (this.originalZone = t.zone));
            let o = { ...this.opts };
            ((o.timeZone = o.timeZone || n), (this.dtf = po(e, o)));
        }
        format() {
    ...
    vo = class {
        constructor(t, e, i) {
            ((this.opts = { style: 'long', ...i }),
                !e && Kl() && (this.rtf = dg(t, i)));
        }
        format(t, e) {
            return this.rtf
                ? this.rtf.format(t, e)
                : Wg(e, t, this.opts.numeric, this.opts.style !== 'long');
        }
        formatToParts(t, e) {
            return this.rtf ? this.rtf.formatToParts(t, e) : [];
        }
    },
    Ul = { firstDay: 1, minimalDays: 4, weekend: [6, 7] },
    B = class s {
        static fromOpts(t) {
            return s.create(
                t.locale,
        ...
        static create(t, e, i, n, o = !1) {
            let r = t || Y.defaultLocale,
                a = r || (o ? 'en-US' : fg()),
                l = e || Y.defaultNumberingSystem,
                c = i || Y.defaultOutputCalendar,
                h = Oo(n) || Y.defaultWeekSettings;
        ...
        get fastNumbers() {
            return (
                this.fastNumbersCached == null &&
                    (this.fastNumbersCached = xg(this)),
        ...
        clone(t) {
            return !t || Object.getOwnPropertyNames(t).length === 0
                ...
                : s.create(
                      ...
                      Oo(t.weekSettings) || this.weekSettings,
                      t.defaultToEN || !1,
                  );
        }
        redefaultToEN(t = {}) {
        ...
        numberFormatter(t = {}) {
            return new wo(this.intl, t.forceSimple || this.fastNumbers, t);
        }
        dtFormatter(t, e = {}) {
            return new ko(t, this.intl, e);
        }
        relFormatter(t = {}) {
            return new vo(this.intl, this.isEnglish(), t);
        }
        listFormatter(t = {}) {
            return hg(this.intl, t);
        }
        isEnglish() {
            return (
                this.locale === 'en' ||
                this.locale.toLowerCase() === 'en-us' ||
                jl(this.intl).locale.startsWith('en-us')
            );
        }
        getWeekSettings() {
    ...
    io = null,
    kt = class s extends Me {
        static get utcInstance() {
            return (io === null && (io = new s(0)), io);
        }
        static instance(t) {
        ...
        get name() {
            return this.fixed === 0 ? 'UTC' : `UTC${Vs(this.fixed, 'narrow')}`;
        }
        get ianaName() {
            return this.fixed === 0
                ? 'Etc/UTC'
                : `Etc/GMT${Vs(-this.fixed, 'narrow')}`;
        }
        offsetName() {
            return this.name;
        }
        formatOffset(t, e) {
            return Vs(this.fixed, e);
        }
        get isUniversal() {
            return !0;
        }
    ...
    if (Mg(s)) {
        ...
        return e === 'default'
            ...
            : e === 'local' || e === 'system'
              ...
              : e === 'utc' || e === 'gmt'
                ? kt.utcInstance
                : kt.parseSpecifier(e) || ae.create(s);
    } else
        return re(s)
            ? kt.instance(s)
            : typeof s == 'object' &&
...
function wg(s) {
    ...
    if (isNaN(t)) {
        ...
        for (let e = 0; e < s.length; e++) {
            ...
            if (s[e].search(Co.hanidec) !== -1) t += _g.indexOf(s[e]);
            else
                for (let n in Xa) {
                    let [o, r] = Xa[n];
                    i >= o && i <= r && (t += i - o);
...
function Ot({ numberingSystem: s }, t = '') {
    let e = s || 'latn',
        i = Mo.get(e);
    i === void 0 && ((i = new Map()), Mo.set(e, i));
    let n = i.get(t);
    return (n === void 0 && ((n = new RegExp(`${Co[e]}${t}`)), i.set(t, n)), n);
}
var Ja = () => Date.now(),
    Ka = 'system',
    Qa = null,
    ...
    Y = class {
        ...
        static resetCaches() {
            (B.resetCache(), ae.resetCache(), R.resetCache(), kg());
        }
    },
    gt = class {
        constructor(t, e) {
    ...
    Yl = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
    Zl = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
function _t(s, t) {
    return new gt(
        'unit out of range',
...
function zi(s, t = 4, e = 1) {
    let { year: i, month: n, day: o } = s,
        r = ql(i, n, o),
        a = Ao(Po(i, n, o), e),
        l = Math.floor((r - a + 14 - t) / 7),
        c;
    return (
        l < 1
            ? ((c = i - 1), (l = Ws(c, t, e)))
...
function ol(s, t = 4, e = 1) {
    let { weekYear: i, weekNumber: n, weekday: o } = s,
        r = Ao(Po(i, 1, t), e),
        a = Qe(i),
        l = n * 7 + o - r - 7 + t,
        c;
...
function vg(s, t = 4, e = 1) {
    let i = Hi(s.weekYear),
        n = wt(s.weekNumber, 1, Ws(s.weekYear, t, e)),
        o = wt(s.weekday, 1, 7);
    return i
        ? n
            ? o
...
function Sg(s) {
    let t = Hi(s.year),
        e = wt(s.ordinal, 1, Qe(s.year));
    return t ? (e ? !1 : _t('ordinal', s.ordinal)) : _t('year', s.year);
}
function Xl(s) {
    let t = Hi(s.year),
        e = wt(s.month, 1, 12),
        i = wt(s.day, 1, Vi(s.year, s.month));
    return t
        ? e
            ? i
                ? !1
...
function cl(s, t, e) {
    return -Ao(Po(s, 1, t), e) + t - 1;
}
function Ws(s, t = 4, e = 1) {
    let i = cl(s, t, e),
        n = cl(s + 1, t, e);
    return (Qe(s) - i + n) / 7;
}
...
function Ui(s) {
    return Dg(s, ['hour', 'minute', 'second', 'millisecond']);
}
var Pg = [
        'January',
        'February',
...
var nc = [
    ...
    oc = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    Ig = ['M', 'T', 'W', 'T', 'F', 'S', 'S'];
function rc(s) {
    switch (s) {
        case 'narrow':
...
function Rg(s) {
    return ac[s.hour < 12 ? 0 : 1];
}
function Ng(s, t) {
    return rc(t)[s.weekday - 1];
}
function zg(s, t) {
    return ic(t)[s.month - 1];
}
function Vg(s, t) {
    return lc(t)[s.year < 0 ? 0 : 1];
}
function Wg(s, t, e = 'always', i = !1) {
    let n = {
            years: ['year', 'yr.'],
...
var Bg = {
    ...
    ft = class s {
        ...
        static parseFormat(t) {
            ...
            return (
                i.length > 0 &&
                    o.push({ literal: n || /^\s+$/.test(i), val: i }),
                o
            );
        }
...
function hc(...s) {
    return (t, e) => {
        let i = {},
            n;
        for (n = 0; n < s.length; n++) i[s[n]] = ie(t[e + n]);
        return [i, null, e + n];
    };
}
var uc = /(?:([Zz])|([+-]\d\d)(?::?(\d\d))?)/,
    Hg = `(?:${uc.source}?(?:\\[(${cc.source})\\])?)?`,
    Lo = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/,
    dc = RegExp(`${Lo.source}${Hg}`),
    Fo = RegExp(`(?:[Tt]${dc.source})?`),
    $g = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/,
    jg = /(\d{4})-?W(\d\d)(?:-?(\d))?/,
    Ug = /(\d{4})-?(\d{3})/,
    Yg = hc('weekYear', 'weekNumber', 'weekDay'),
    Zg = hc('year', 'ordinal'),
    qg = /(\d{4})-(\d\d)-(\d\d)/,
    fc = RegExp(`${Lo.source} ?(?:${uc.source}|(${cc.source}))?`),
    Gg = RegExp(`(?: ${fc.source})?`);
function ts(s, t, e) {
    let i = s[t];
    return D(i) ? e : ie(i);
...
function Xg(s, t) {
    return [
        { year: ts(s, t), month: ts(s, t + 1, 1), day: ts(s, t + 2, 1) },
        null,
        t + 3,
    ];
}
...
function Hs(s, t) {
    let e = !s[t] && !s[t + 1],
        i = ji(s[t + 1], s[t + 2]),
        n = e ? null : kt.instance(i);
    return [{}, n, t + 3];
}
function $s(s, t) {
    let e = s[t] ? ae.create(s[t]) : null;
    return [{}, e, t + 1];
}
var Jg = RegExp(`^T?${Lo.source}$`),
    Kg =
...
function Ro(s, t, e, i, n, o, r) {
    let a = {
        year: t.length === 2 ? To(ie(t)) : ie(t),
        month: sc.indexOf(e) + 1,
        day: ie(i),
        hour: ie(n),
        minute: ie(o),
    };
    return (
        r && (a.second = ie(r)),
        s && (a.weekday = s.length > 3 ? nc.indexOf(s) + 1 : oc.indexOf(s) + 1),
        a
    );
}
var em =
...
function sm(s) {
    let [, t, e, i, n, o, r, a, l, c, h, u] = s,
        d = Ro(t, n, i, e, o, r, a),
        f;
    return (l ? (f = tm[l]) : c ? (f = 0) : (f = ji(h, u)), [d, new kt(f)]);
}
function im(s) {
    return s
        .replace(/\([^()]*\)|[\n\t]/g, ' ')
...
function ul(s) {
    let [, t, e, i, n, o, r, a] = s;
    return [Ro(t, n, i, e, o, r, a), kt.utcInstance];
}
function am(s) {
    let [, t, e, i, n, o, r, a] = s;
    return [Ro(t, a, e, i, n, o, r), kt.utcInstance];
}
var lm = is($g, Fo),
    cm = is(jg, Fo),
    hm = is(Ug, Fo),
    ...
    gm = ns(rs, Hs, $s);
function mm(s) {
    return os(s, [lm, gc], [cm, dm], [hm, fm], [um, gm]);
}
function pm(s) {
    return os(im(s), [em, sm]);
}
function bm(s) {
    return os(s, [nm, ul], [om, ul], [rm, am]);
}
function ym(s) {
    return os(s, [Kg, Qg]);
}
...
var wm = is(qg, Gg),
    ...
    vm = ns(rs, Hs, $s);
function Sm(s) {
    return os(s, [wm, gc], [km, vm]);
}
var dl = 'Invalid Duration',
    mc = {
        weeks: {
            days: 7,
            hours: 168,
...
function pc(s, t) {
    ...
    for (let i of Tm.slice(1)) t[i] && (e += t[i] * s[i].milliseconds);
    return e;
}
function fl(s, t) {
    let e = pc(s, t) < 0 ? -1 : 1;
...
var tt = class s {
        ...
        static invalid(t, e = null) {
            if (!t)
                throw new Q('need to specify a reason the Duration is invalid');
            let i = t instanceof gt ? t : new gt(t, e);
        ...
        plus(t) {
            ...
            let e = s.fromDurationLike(t),
                i = {};
            for (let n of Se)
                (ss(e.values, n) || ss(this.values, n)) &&
        ...
        set(t) {
            if (!this.isValid) return this;
            let e = { ...this.values, ...Wi(t, s.normalizeUnit) };
        ...
        normalize() {
            if (!this.isValid) return this;
            let t = this.toObject();
            return (fl(this.matrix, t), Ut(this, { values: t }, !0));
        }
        rescale() {
            if (!this.isValid) return this;
            let t = gl(this.normalize().shiftToAll().toObject());
        ...
        shiftTo(...t) {
            ...
            for (let r in i)
                i[r] !== 0 &&
                    (e[o] += r === o ? i[r] : i[r] / this.matrix[o][r]);
            return (fl(this.matrix, e), Ut(this, { values: e }, !0));
        }
        shiftToAll() {
            return this.isValid
                ? this.shiftTo(
        ...
        equals(t) {
            ...
            for (let i of Se) if (!e(this.values[i], t.values[i])) return !1;
            return !0;
        }
    },
    Xe = 'Invalid Interval';
function Dm(s, t) {
    return !s || !s.isValid
        ? es.invalid('missing or invalid start')
        : !t || !t.isValid
          ? es.invalid('missing or invalid end')
          : t < s
            ? es.invalid(
                  'end before start',
...
var es = class s {
        ...
        static invalid(t, e = null) {
            if (!t)
                throw new Q('need to specify a reason the Interval is invalid');
            let i = t instanceof gt ? t : new gt(t, e);
        ...
        static fromISO(t, e) {
            ...
            if (i && n) {
                ...
                if (r) {
                    let c = tt.fromISO(n, e);
                    if (c.isValid) return s.after(o, c);
                } else if (l) {
                    let c = tt.fromISO(i, e);
        ...
        toISO(t) {
            return this.isValid ? `${this.s.toISO(t)}/${this.e.toISO(t)}` : Xe;
        }
        toISODate() {
            return this.isValid
    ...
    Ke = class {
        ...
        static isValidIANAZone(t) {
            return ae.isValidZone(t);
        }
        static normalizeZone(t) {
            return ne(t, Y.defaultZone);
        }
        ...
        static features() {
            return { relative: Kl(), localeWeek: Ql() };
        }
    };
function ml(s, t) {
...
function N(s, t = (e) => e) {
    return { regex: s, deser: ([e]) => t(wg(e)) };
}
var Im = '\xA0',
    bc = `[ ${Im}]`,
    yc = new RegExp(bc, 'g');
function Em(s) {
    return s.replace(/\./g, '\\.?').replace(yc, bc);
}
function pl(s) {
    return s.replace(/\./g, '').replace(yc, ' ').toLowerCase();
}
function Tt(s, t) {
    return s === null
        ? null
        : {
              regex: RegExp(s.map(Em).join('|')),
              deser: ([e]) => s.findIndex((i) => pl(e) === pl(i)) + t,
          };
}
function bl(s, t) {
        ...
        m = ((p) => {
            ...
            switch (p.val) {
                ...
                case 'MM':
                    return N(i);
                case 'MMM':
                    return Tt(t.months('short', !0), 1);
                case 'MMMM':
                    return Tt(t.months('long', !0), 1);
                case 'L':
                    return N(a);
                case 'LL':
                    return N(i);
                case 'LLL':
                    return Tt(t.months('short', !1), 1);
                case 'LLLL':
                    return Tt(t.months('long', !1), 1);
                case 'd':
                    return N(a);
                case 'dd':
                    return N(i);
                ...
                case 'c':
                    return N(e);
                case 'EEE':
                    return Tt(t.weekdays('short', !1), 1);
                case 'EEEE':
                    return Tt(t.weekdays('long', !1), 1);
                case 'ccc':
                    return Tt(t.weekdays('short', !0), 1);
                case 'cccc':
                    return Tt(t.weekdays('long', !0), 1);
                case 'Z':
                case 'ZZ':
                    return bl(
                ...
                case 'ZZZ':
                    return bl(new RegExp(`([+-]${a.source})(${i.source})?`), 2);
                case 'z':
...
var oo = null;
function Bm() {
    return (oo || (oo = R.fromMillis(1555555555555)), oo);
}
function Hm(s, t) {
    if (s.literal) return s;
    let e = ft.macroTokenToFormatOpts(s.val),
        i = wc(e, t);
    return i == null || i.includes(void 0) ? s : i;
}
function xc(s, t) {
    return Array.prototype.concat(...s.map((e) => Hm(e, t)));
}
var Bi = class {
    constructor(t, e) {
        if (
            ((this.locale = t),
            (this.format = e),
            (this.tokens = xc(ft.parseFormat(e), t)),
            (this.units = this.tokens.map((i) => Fm(i, t))),
            (this.disqualifyingUnit = this.units.find((i) => i.invalidReason)),
            !this.disqualifyingUnit)
        ) {
            let [i, n] = zm(this.units);
            ((this.regex = RegExp(i, 'i')), (this.handlers = n));
        }
    }
    explainFromTokens(t) {
        if (this.isValid) {
            let [e, i] = Vm(t, this.regex, this.handlers),
                [n, o, r] = i ? Wm(i) : [null, null, void 0];
            if (ss(i, 'a') && ss(i, 'H'))
                throw new oe(
...
function wc(s, t) {
    if (!s) return null;
    let i = ft.create(t, s).dtFormatter(Bm()),
        n = i.formatToParts(),
        o = i.resolvedOptions();
    return n.map((r) => Nm(r, s, o));
}
...
function Je(s, t, e, i, n, o) {
    let { setZone: r, zone: a } = e;
    if ((s && Object.keys(s).length !== 0) || t) {
        let l = t || a,
            c = R.fromObject(s, { ...e, zone: l, specificOffset: o });
...
function co(s, t, e) {
    ...
    if (
        ...
        return n;
    if (t) {
        if (((n += '-'), (n += J(s.c.month)), e === 'month')) return n;
        n += '-';
    } else if (((n += J(s.c.month)), e === 'month')) return n;
    return ((n += J(s.c.day)), n);
}
function _l(s, t, e, i, n, o, r) {
    ...
    switch (r) {
        ...
        case 'year':
            break;
        default:
            if (((l += J(s.c.hour)), r === 'hour')) break;
            if (t) {
                if (((l += ':'), (l += J(s.c.minute)), r === 'minute')) break;
                a && ((l += ':'), (l += J(s.c.second)));
            } else {
                if (((l += J(s.c.minute)), r === 'minute')) break;
                a && (l += J(s.c.second));
            }
            if (r === 'second') break;
            a &&
                (!i || s.c.millisecond !== 0) &&
                ((l += '.'), (l += J(s.c.millisecond, 3)));
    }
    return (
        n &&
...
function qm(s) {
    if ((zs === void 0 && (zs = Y.now()), s.type !== 'iana'))
        return s.offset(zs);
    let t = s.name,
        e = Do.get(t);
    return (e === void 0 && ((e = s.offset(zs)), Do.set(t, e)), e);
}
function kl(s, t) {
    let e = ne(t.zone, Y.defaultZone);
    if (!e.isValid) return R.invalid(Ns(e));
    let i = B.fromObject(t),
        n,
        o;
    if (D(s.year)) n = Y.now();
    else {
        for (let l of Ei) D(s[l]) && (s[l] = vc[l]);
        let r = Xl(s) || Jl(s);
...
function vl(s, t, e) {
    let i = D(e.round) ? !0 : e.round,
        n = D(e.rounding) ? 'trunc' : e.rounding,
        o = (a, l) => (
...
var zs,
    ...
    R = class s {
        constructor(t) {
            ...
            if (!i)
                if (t.old && t.old.ts === this.ts && t.old.zone.equals(e))
                    ...
                    let a = re(t.o) && !t.old ? t.o : e.offset(this.ts);
                    ((n = Pi(this.ts, a)),
                        (i = Number.isNaN(n.year)
                            ? new gt('invalid input')
                            : null),
                        (n = i ? null : n),
                        (o = i ? null : a));
                }
        ...
        static fromObject(t, e = {}) {
            t = t || {};
            let i = ne(e.zone, Y.defaultZone);
            if (!i.isValid) return s.invalid(Ns(i));
            let n = B.fromObject(e),
                o = Wi(t, wl),
                { minDaysInFirstWeek: r, startOfWeek: a } = al(o, n),
                l = Y.now(),
                ...
                d = !D(o.month) || !D(o.day),
                f = u || d,
                g = o.weekYear || o.weekNumber;
            if ((f || h) && g)
                throw new oe(
                    "Can't mix weekYear/weekNumber units with year/month/day or ordinals",
                );
            if (d && h) throw new oe("Can't mix ordinal dates with month/day");
            let m = g || (o.weekday && !f),
                p,
                b,
                y = Pi(l, c);
            m
                ? ((p = Ym), (b = jm), (y = zi(y, r, a)))
                : h
                  ? ((p = Zm), (b = Um), (y = no(y)))
                  : ((p = Ei), (b = vc));
            let _ = !1;
            for (let C of p) {
                let A = o[C];
                D(A) ? (_ ? (o[C] = b[C]) : (o[C] = y[C])) : (_ = !0);
            }
            let w = m ? vg(o, r, a) : h ? Sg(o) : Xl(o),
                x = w || Jl(o);
            if (x) return s.invalid(x);
            let k = m ? ol(o, r, a) : h ? rl(o) : o,
                [S, M] = Ii(k, c, i),
        ...
        static fromISO(t, e = {}) {
            let [i, n] = mm(t);
            return Je(i, n, e, 'ISO 8601', t);
        }
        static fromRFC2822(t, e = {}) {
            let [i, n] = pm(t);
            return Je(i, n, e, 'RFC 2822', t);
        }
        static fromHTTP(t, e = {}) {
            let [i, n] = bm(t);
            return Je(i, n, e, 'HTTP', e);
        }
        static fromFormat(t, e, i = {}) {
            ...
            let { locale: n = null, numberingSystem: o = null } = i,
                ...
                [a, l, c, h] = $m(r, t, e);
            return h ? s.invalid(h) : Je(a, l, i, `format ${e}`, t, c);
        }
        ...
        static fromSQL(t, e = {}) {
            let [i, n] = Sm(t);
            return Je(i, n, e, 'SQL', t);
        }
        static invalid(t, e = null) {
            if (!t)
                throw new Q('need to specify a reason the DateTime is invalid');
            let i = t instanceof gt ? t : new gt(t, e);
            if (Y.throwOnInvalid) throw new ho(i);
            return new s({ invalid: i });
        }
        static isDateTime(t) {
        ...
        static parseFormatForOpts(t, e = {}) {
            let i = wc(t, B.fromObject(e));
            return i ? i.map((n) => (n ? n.val : null)).join('') : null;
        }
        static expandFormat(t, e = {}) {
            return xc(ft.parseFormat(t), B.fromObject(e))
                .map((n) => n.val)
                .join('');
        }
        static resetCache() {
        ...
        get ordinal() {
            return this.isValid ? no(this.c).ordinal : NaN;
        }
        get monthShort() {
            return this.isValid
        ...
        setZone(t, { keepLocalTime: e = !1, keepCalendarTime: i = !1 } = {}) {
            if (((t = ne(t, Y.defaultZone)), t.equals(this.zone))) return this;
            if (t.isValid) {
                let n = this.ts;
                if (e || i) {
        ...
        set(t) {
            if (!this.isValid) return this;
            let e = Wi(t, wl),
                { minDaysInFirstWeek: i, startOfWeek: n } = al(e, this.loc),
                o = !D(e.weekYear) || !D(e.weekNumber) || !D(e.weekday),
                r = !D(e.ordinal),
                a = !D(e.year),
                l = !D(e.month) || !D(e.day),
                c = a || l,
            ...
            if (l && r) throw new oe("Can't mix ordinal dates with month/day");
            let u;
            o
                ? (u = ol({ ...zi(this.c, i, n), ...e }, i, n))
                : D(e.ordinal)
                  ? ((u = { ...this.toObject(), ...e }),
                    D(e.day) && (u.day = Math.min(Vi(u.year, u.month), u.day)))
                  : (u = rl({ ...no(this.c), ...e }));
            let [d, f] = Ii(u, this.o, this.zone);
            return ve(this, { ts: d, o: f });
        }
        plus(t) {
            if (!this.isValid) return this;
            let e = tt.fromDurationLike(t);
            return ve(this, xl(this, e));
        }
        minus(t) {
            if (!this.isValid) return this;
            let e = tt.fromDurationLike(t).negate();
            return ve(this, xl(this, e));
        }
        startOf(t, { useLocaleWeeks: e = !1 } = {}) {
            if (!this.isValid) return this;
            let i = {},
                n = tt.normalizeUnit(t);
            switch (n) {
                case 'years':
                    i.month = 1;
                case 'quarters':
        ...
        toISO({
            ...
            return (
                Ei.indexOf(r) >= 3 && (l += 'T'),
                (l += _l(this, a, e, i, n, o, r)),
                l
            );
        }
        toISODate({ format: t = 'extended', precision: e = 'day' } = {}) {
            return this.isValid ? co(this, t === 'extended', Li(e)) : null;
        }
        toISOWeekDate() {
        ...
        toSQLDate() {
            return this.isValid ? co(this, !0) : null;
        }
        toSQLTime({
            includeOffset: t = !0,
            includeZone: e = !1,
        ...
        until(t) {
            return this.isValid ? es.fromDateTimes(this, t) : this;
        }
        hasSame(t, e, i) {
        ...
        toRelativeCalendar(t = {}) {
            return this.isValid
                ? vl(t.base || s.fromObject({}, { zone: this.zone }), this, {
                      ...t,
                      numeric: 'auto',
        ...
        static min(...t) {
            ...
            return ll(t, (e) => e.valueOf(), Math.min);
        }
        static max(...t) {
            if (!t.every(s.isDateTime))
                throw new Q('max requires all arguments be DateTimes');
            return ll(t, (e) => e.valueOf(), Math.max);
        }
        ...
        static fromFormatParser(t, e, i = {}) {
            ...
            return h ? s.invalid(h) : Je(a, l, i, `format ${e.format}`, t, c);
        }
...
function Fs(s) {
    ...
    if (s && s.valueOf && re(s.valueOf())) return R.fromJSDate(s);
...
function Xm({ cachedData: s, maxHeight: t, options: e, type: i }) {
    return {
        userPointBackgroundColor: e?.pointBackgroundColor,
        userXGridColor: e?.scales?.x?.grid?.color,
        userYGridColor: e?.scales?.y?.grid?.color,
        userRadialGridColor: e?.scales?.r?.grid?.color,
        userRadialTicksColor: e?.scales?.r?.ticks?.color,
        init() {
            (this.initChart(),
                this.$wire.$on('updateChartData', ({ data: n }) => {
                    let o = this.getChart();
                    o && ((s = n), (o.data = n), o.update('resize'));
                }),
                Alpine.effect(() => {
                    (Alpine.store('theme'),
                        this.$nextTick(() => {
                            let n = this.getChart();
                            n && (n.destroy(), this.initChart());
                        }));
                }),
                window
        ...
        initChart(n = null) {
            var a, l, c, h, u, d, f, g, m, p, b, y, _, w, x, k;
            if (
                !this.$refs.canvas ||
                ...
                return;
            ((Mt.defaults.animation.duration = 0),
                (Mt.defaults.backgroundColor = getComputedStyle(
                    this.$refs.backgroundColorElement,
                ).color));
            let o = getComputedStyle(this.$refs.borderColorElement).color;
            ((Mt.defaults.borderColor = o),
                (Mt.defaults.color = getComputedStyle(
                    this.$refs.textColorElement,
                ).color),
                (Mt.defaults.font.family = getComputedStyle(
                    this.$el,
                ).fontFamily),
            ...
            if (
                (e ?? (e = {}),
                e.borderWidth ?? (e.borderWidth = 2),
                e.maintainAspectRatio ?? (e.maintainAspectRatio = !!t),
                (e.pointBackgroundColor = this.userPointBackgroundColor ?? o),
                e.pointHitRadius ?? (e.pointHitRadius = 4),
                e.pointRadius ?? (e.pointRadius = 2),
                e.scales ?? (e.scales = {}),
                (a = e.scales).x ?? (a.x = {}),
                (l = e.scales.x).border ?? (l.border = {}),
                (c = e.scales.x.border).display ?? (c.display = !1),
                (h = e.scales.x).grid ?? (h.grid = {}),
                (e.scales.x.grid.color = this.userXGridColor ?? r),
                (u = e.scales.x.grid).display ?? (u.display = !1),
                (d = e.scales).y ?? (d.y = {}),
                (f = e.scales.y).border ?? (f.border = {}),
                (g = e.scales.y.border).display ?? (g.display = !1),
                (m = e.scales.y).grid ?? (m.grid = {}),
                (e.scales.y.grid.color = this.userYGridColor ?? r),
                ['doughnut', 'pie', 'polarArea'].includes(i) &&
                    ((p = e.scales.x).display ?? (p.display = !1),
                    (b = e.scales.y).display ?? (b.display = !1),
                    (y = e.scales.y.grid).display ?? (y.display = !1)),
                i === 'polarArea')
            ) {
                let S = getComputedStyle(this.$refs.textColorElement).color;
                ((_ = e.scales).r ?? (_.r = {}),
                    (w = e.scales.r).grid ?? (w.grid = {}),
                    (e.scales.r.grid.color = this.userRadialGridColor ?? r),
                    (x = e.scales.r).ticks ?? (x.ticks = {}),
                    (e.scales.r.ticks.color = this.userRadialTicksColor ?? S),
                    (k = e.scales.r.ticks).backdropColor ??
                        (k.backdropColor = 'transparent'));
            }
