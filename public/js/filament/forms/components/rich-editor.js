...
function hp(t, e) {
    ...
    return (
        o.length == 0 && t.err("No node type or group '" + e + "' found"), o
    );
}
function pp(t) {
    if (t.eat('(')) {
...
var Jy =
    ...
    Fs = (t, e) => {
        ...
        return (
            n.node.type === o?.type && Re(t.doc, n.pos) && t.join(n.pos), !0
        );
    },
    Vs = (t, e) => {
        let n = et((s) => s.type === e)(t.selection);
...
function Db(t, e) {
    ...
    return (
        i.setSelection(D.near(i.doc.resolve(n.pos + 1))), t.dispatch(i), !1
    );
}
function Ib(t) {
...
var Lb = 500,
    tn = class t {
        ...
        addTransform(e, n, r, o) {
            ...
            let c = s - r.depth;
            return (
                c > zb && ((l = Bb(l, c)), (s -= c)), new t(l.append(i), s)
            );
        }
        remapping(e, n) {
            let r = new jn();
...
`);
                              return (
                                  a.replaceWith(c, d, r.schema.text(h)), !0
                              );
                          });
                },
                'Shift-Tab': ({ editor: t }) => {
...
`);
                                return (
                                    l.replaceWith(a, c, r.schema.text(f)), !0
                                );
                            });
                },
                Enter: ({ editor: t }) => {
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    return l === void 0
                        ...
                        : r.nodeAt(l)
                          ? t.commands.command(
                                ({ tr: c }) => (
                                    c.setSelection(I.near(r.resolve(l))), !0
                                ),
                            )
                          : t.commands.exitCode();
                },
            ...
            return {
                Enter: ({ editor: t }) => {
                    ...
                    let T = m,
                        A = m + p.nodeSize;
                    return (
                        x.delete(T, A), x.scrollIntoView(), n.dispatch(x), !0
                    );
                },
            };
        },
...
function ri(t) {
    return (
        Z.initialized || R0(), E0(Z.parser.start, t, uf(Z.scanner.start, t))
    );
}
ri.scan = uf;
        ...
        props: {
            handleKeyDown(S, k) {
                ...
                if (k.key === 'Escape' || k.key === 'Esc') {
                    ...
                    return (
                        (A = y?.onExit) == null || A.call(y, me), C(S, t), !0
                    );
                }
                return (
                    (($ = y?.onKeyDown) == null
...
function na(t, e) {
    ...
    return (
        e ? e.doc != t.doc && Ph(e.doc, t.doc, 0, r) : t.doc.descendants(r), n
    );
}
function ox(t, e, n, r) {
    let o = oe.get(e);
    ...
    let i = new P({
        ...
        state: {
            init(s, l) {
                ...
                return (
                    r && c && (c[d] = (u, f) => new r(u, n, f)), new kx(-1, !1)
                );
            },
            apply(s, l) {
                return l.apply(s);
