    ...
    if (s) {
        ...
        for (; m && i && u !== g; ) {
            let S = Tt(m),
                ...
                w = nt(m),
                D = E.left + (m.clientLeft + parseFloat(w.paddingLeft)) * S.x,
                A = E.top + (m.clientTop + parseFloat(w.paddingTop)) * S.y;
            ((l *= S.x),
                (c *= S.y),
                (f *= S.x),
                (d *= S.y),
...
function le(n, t) {
    ...
    return t ? t.left + e : $t(ct(n)).left + e;
}
function bi(n, t) {
...
var h,
    ...
    Hn = Oe && !Pi && !$e && 'draggable' in document.createElement('div'),
    Wi = (function () {
        if (Oe) {
            if (mt) return !1;
...
function v(n, t) {
    ...
    var e = {
        ...
        supportPointer:
            v.supportPointer !== !1 && 'PointerEvent' in window && (!Gt || $e),
...
v.prototype = {
    ...
    _emulateDragOver: function () {
        if (at) {
            ((this._lastX = at.clientX), (this._lastY = at.clientY), $i());
            for (
        ...
        if (
            ...
            if (!A || (Yn(t, u, this) && !A.animated)) {
                ...
                if (((i = C), (s = N(i)), he(I, e, h, o, i, s, t, !1) !== !1))
                    return (E(), e.insertBefore(h, C), (R = e), D(), w(!0));
                ...
                if (X !== !1)
                    return (
                        ...
                        B && !Y
                            ? e.appendChild(h)
                            : i.parentNode.insertBefore(h, B ? Y : i),
...
function Yn(n, t, e) {
    var i = N(Ke(e.el, e.options.draggable)),
        o = Vi(e.el, e.options, y),
        s = 10;
    return t
        ? n.clientX > o.right + s ||
...
function Jn() {
    ...
    return (
        (n.prototype = {
            ...
            nulling: function () {
                ((xe = ze = Yt = Xe = Ut = Be = Fe = null), (M.length = 0));
            },
                ...
                var tt =
                    ...
                    z =
                        ...
                        (Math.abs(S - s) <= r && W + A < J) -
                            (Math.abs(m - s) <= r && !!W);
                if (!M[d]) for (var k = 0; k <= d; k++) M[k] || (M[k] = {});
                ((M[d].vx != tt || M[d].vy != z || M[d].el !== u) &&
                    ((M[d].el = u),
                    (M[d].vx = tt),
                    (M[d].vy = z),
                    clearInterval(M[d].pid),
                    (tt != 0 || z != 0) &&
                        ((c = !0),
                        (M[d].pid = setInterval(
                            function () {
