(() => {
        ...
        ce = le((t, n) => {
            (function (i, a, w) {
                ...
                for (
                    ...
                    u[111 + m] = 'f' + m;
                for (m = 0; m <= 9; ++m) u[m + 96] = m.toString();
                function P(e, r, s) {
                ...
                function T(e, r) {
                    ...
                    for (s = Q(e), k = 0; k < s.length; ++k)
                        ((h = s[k]),
                            ...
                            E(h) && A.push(h));
                    return (
                        (r = Y(h, A, r)), { key: h, modifiers: A, action: r }
                    );
                }
                function R(e, r) {
                    return e === null || e === a
                ...
                function g(e) {
                    ...
                    function I(o, f, p, l, d, b) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                ((ee || te) && r._callbacks[o].splice(c, 1),
                                    C.push(_));
                            }
                        return C;
                    }
                    ...
                    r._handleKey = function (o, f, p) {
                        ...
                        for (d = 0; d < l.length; ++d)
                            l[d].seq && (c = Math.max(c, l[d].level));
                        for (d = 0; d < l.length; ++d) {
                            if (l[d].seq) {
                                if (l[d].level != c) continue;
                                ((_ = !0),
                                    (b[l[d].seq] = 1),
                                    N(l[d].callback, p, l[d].combo, l[d].seq));
                                continue;
                            }
                            _ || N(l[d].callback, p, l[d].combo);
                        }
                        var C = p.type == 'keypress' && A;
                        (p.type == D && !E(o) && !C && L(b),
                            (A = _ && p.type == 'keydown'));
                    };
                    function K(o) {
                    ...
                    function z(o, f, p, l, d) {
                        ...
                        ((c = T(o, p)),
                            (r._callbacks[c.key] = r._callbacks[c.key] || []),
                            I(c.key, c.modifiers, { type: c.action }, l, o, d),
                            r._callbacks[c.key][l ? 'unshift' : 'push']({
                                callback: f,
    ...
    (function (t) {
        if (t) {
            ...
            ((t.prototype.stopCallback = function (a, w, u, y) {
                var v = this;
                return v.paused ? !0 : n[u] || n[y] ? !1 : i.call(v, a, w, u);
            }),
                (t.prototype.bindGlobal = function (a, w, u) {
                    var y = this;
                    if ((y.bind(a, w, u), a instanceof Array)) {
            ...
            t.directive(
                ...
                (n, { modifiers: i, expression: a }, { evaluate: w }) => {
                    ...
                    ((i = i.map((y) =>
                        ...
                        q.default.bind(i, (y) => {
                            let v = J();
                            (v && !v.contains(n)) || (y.preventDefault(), u());
                        }),
        ...
        Livewire.interceptRequest(
            ({ request: t, onError: n, onFailure: i }) => {
                (n(({ response: a, preventDefault: w }) => {
                    let u = window.filamentErrorNotifications;
                    if (!u) return;
                    try {
                        let S = t?.payload;
                        if (S && JSON.parse(S).components.length === 1) {
                            for (let M of JSON.parse(S).components)
                                if (
                                    JSON.parse(M.snapshot).data
    ...
    window.setUpSpaModeUnsavedDataChangesAlert = ({
        ...
        let a = () =>
            ...
            w = () => confirm(t);
        (document.addEventListener('livewire:navigate', (u) => {
            if (typeof n() < 'u') {
                if (!a() || w()) return;
                u.preventDefault();
            }
            ...
            window.addEventListener('beforeunload', (u) => {
                a() && (u.preventDefault(), (u.returnValue = !0));
            }));
    };
